...
export const fetchAddressCategories = (queryParams) => (dispatch) => {
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.addressCategoriesFetched({
...
export const fetchAddressCategory = (id) => (dispatch) => {
  if (!id) {
    return dispatch(
      actions.addressCategoryFetched({ addressCategoryForEdit: undefined })
    );
  }
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.addressCategoryFetched({
          addressCategoryForEdit: addressCategory,
        })
      );
    })
    .catch((error) => {
...
export const createAddressCategory =
  (addressCategoryForCreation) => (dispatch) => {
    dispatch(actions.startCall({ callType: callTypes.action }));
    return requestFromServer

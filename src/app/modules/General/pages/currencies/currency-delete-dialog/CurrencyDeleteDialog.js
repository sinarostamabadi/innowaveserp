...
export function CurrencyDeleteDialog({ id, show, onHide }) {
  ...
  const deleteCurrency = () => {
    // server request for deleting currency by id
  ...
  return (
    ...
    >
      ...
      <Modal.Header closeButton>
        <Modal.Title id="example-modal-sizes-title-lg">{t("Common.Delete") + " " + t("Currency.Entity")}</Modal.Title>
      </Modal.Header>
      <Modal.Body>

...
export function PersonSpecialDaysUIProvider({
  personSpecialDaysUIEvents,
  children,
}) {
  const [queryParams, setQueryParamsBase] = useState(
    getConfig(PersonSpecialDayModel).initialFilter
  );
  ...
  const value = {
    ...
    newPersonSpecialDayButtonClick:
      personSpecialDaysUIEvents.newPersonSpecialDayButtonClick,
    openEditPersonSpecialDayPage:
      personSpecialDaysUIEvents.openEditPersonSpecialDayPage,
    openDeletePersonSpecialDayDialog:
      personSpecialDaysUIEvents.openDeletePersonSpecialDayDialog,
    openDeletePersonSpecialDaysDialog:
      personSpecialDaysUIEvents.openDeletePersonSpecialDaysDialog,
    openFetchPersonSpecialDaysDialog:
      personSpecialDaysUIEvents.openFetchPersonSpecialDaysDialog,

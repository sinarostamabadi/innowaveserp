...
import { useRestaurantsUIContext, RestaurantsUIConsumer } from "./RestaurantsUIContext";
...
export function RestaurantsCard() {
  ...
  const restaurantsUIProps = useMemo(() => {
    return {
      ...
      openDeleteRestaurantsDialog: restaurantsUIContext.openDeleteRestaurantsDialog,
      openEditRestaurantPage: restaurantsUIContext.openEditRestaurantPage,
      openUpdateRestaurantsStatusDialog: restaurantsUIContext.openUpdateRestaurantsStatusDialog,
      openFetchRestaurantsDialog: restaurantsUIContext.openFetchRestaurantsDialog,
    };

  ...
  return (
    <Suspense fallback={<LayoutSplashScreen />}>
      <Switch>
        ...
        <ContentRoute
          path="/general/addressCategories/new"
          component={AddressCategoryEdit}
        />
        <ContentRoute
          path="/general/addressCategories/:id/edit"
          component={AddressCategoryEdit}
        />
        <ContentRoute
          path="/general/addressCategories"
          component={AddressCategoriesPage}
        />
        ...
        <ContentRoute
          path="/General/calendars/:id/edit"
        ...
        {/* begin CoffeeShops */}
        <ContentRoute
          path="/General/coffeeShops/new"
          component={CoffeeShopEdit}
        />
        <ContentRoute
          path="/General/coffeeShops/:id/edit"
          component={CoffeeShopEdit}
        />
        ...
        <ContentRoute
          path="/General/countries/:id/edit"
        ...
        <ContentRoute
          path="/General/currencies/:id/edit"
        ...
        {/* begin CurrencyRates */}
        <ContentRoute
          path="/General/currencyRates/new"
          component={CurrencyRateEdit}
        />
        <ContentRoute
          path="/General/currencyRates/:id/edit"
          component={CurrencyRateEdit}
        />
        <ContentRoute
          path="/General/currencyRates"
        ...
        {/* begin DiscountTypes */}
        <ContentRoute
          path="/General/discountTypes/new"
          component={DiscountTypeEdit}
        />
        <ContentRoute
          path="/General/discountTypes/:id/edit"
          component={DiscountTypeEdit}
        />
        <ContentRoute
          path="/General/discountTypes"
        ...
        {/* begin Educations */}
        <ContentRoute
          path="/General/educations/new"
          component={EducationEdit}
        />
        <ContentRoute
          path="/General/educations/:id/edit"
          component={EducationEdit}
        />
        ...
        {/* begin PersonGroups */}
        <ContentRoute
          path="/General/personGroups/new"
          component={PersonGroupEdit}
        />
        <ContentRoute
          path="/General/personGroups/:id/edit"
          component={PersonGroupEdit}
        />
        <ContentRoute
          path="/General/personGroups"
        ...
        <ContentRoute
          path="/General/personSpecialDays/new"
          component={PersonSpecialDayEdit}
        />
        <ContentRoute
          path="/General/personSpecialDays/:id/edit"
          component={PersonSpecialDayEdit}
        />
        <ContentRoute
          path="/General/personSpecialDays"
          component={PersonSpecialDaysPage}
        />
        {/* end PersonSpecialDays */}

        {/* begin PhoneTypes */}
        <ContentRoute
          path="/general/phoneTypes/new"
          component={PhoneTypeEdit}
        />
        <ContentRoute
          path="/general/phoneTypes/:id/edit"
          component={PhoneTypeEdit}
        />
        ...
        <ContentRoute
          path="/General/provinces/:id/edit"
        ...
        <ContentRoute
          path="/General/townships/:id/edit"
          component={TownshipEdit}
        />
        ...
        <ContentRoute
          path="/General/unitConversions/new"
          component={UnitConversionEdit}
        />
        <ContentRoute
          path="/General/unitConversions/:id/edit"
          component={UnitConversionEdit}
        />
        <ContentRoute
          path="/General/unitConversions"
        ...
        <ContentRoute
          path="/General/unitMeasureGroups/new"
          component={UnitMeasureGroupEdit}
        />
        <ContentRoute
          path="/General/unitMeasureGroups/:id/edit"
          component={UnitMeasureGroupEdit}
        />
        <ContentRoute
          path="/General/unitMeasureGroups"
          component={UnitMeasureGroupsPage}
        />
        {/* end UnitMeasureGroups */}

        {/* begin Warehouses */}
        <ContentRoute
          path="/General/warehouses/new"
          component={WarehouseEdit}
        />
        <ContentRoute
          path="/General/warehouses/:id/edit"
          component={WarehouseEdit}
        />

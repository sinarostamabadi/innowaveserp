...
import {
  useCurrencyRatesUIContext,
  CurrencyRatesUIConsumer,
} from "./CurrencyRatesUIContext";
  ...
  const currencyRatesUIProps = useMemo(() => {
    return {
      ...
      newCurrencyRateButtonClick:
        currencyRatesUIContext.newCurrencyRateButtonClick,
      openDeleteCurrencyRatesDialog:
        currencyRatesUIContext.openDeleteCurrencyRatesDialog,
      openEditCurrencyRatePage: currencyRatesUIContext.openEditCurrencyRatePage,
      openUpdateCurrencyRatesStatusDialog:
        currencyRatesUIContext.openUpdateCurrencyRatesStatusDialog,
      openFetchCurrencyRatesDialog:
        currencyRatesUIContext.openFetchCurrencyRatesDialog,
    };

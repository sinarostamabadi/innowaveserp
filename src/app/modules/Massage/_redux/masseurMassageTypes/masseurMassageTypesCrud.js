...
export function updateStatusForMasseurMassageTypes(ids, status) {
  return axios.post(
    `${MASSEURMASSAGETYPES_URL}/updateStatusForMasseurMassageTypes`,
    {
      ids,
      status,
    }
...
export function deleteMasseurMassageType(masseurMassageTypesId) {
  return axios.delete(
    `${MASSEURMASSAGETYPES_URL}/delete/${masseurMassageTypesId}`
  );
}
// DELETE MasseurMassageTypes by ids
export function deleteMasseurMassageTypes(ids) {
  return axios.post(
    `${MASSEURMASSAGETYPES_URL}/deleteMasseurMassageTypes`,
    ids
  );
}

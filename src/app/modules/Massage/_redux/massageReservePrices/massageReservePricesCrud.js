...
export function updateMassageReservePrice(id, massageReservePrices) {
  return axios.put(
    `${MASSAGERESERVEPRICES_URL}/put/${id}`,
    massageReservePrices
  );
}
// UPDATE Status
export function updateStatusForMassageReservePrices(ids, status) {
  return axios.post(
    `${MASSAGERESERVEPRICES_URL}/updateStatusForMassageReservePrices`,
    {
      ids,
      status,
    }
...
export function deleteMassageReservePrice(massageReservePricesId) {
  return axios.delete(
    `${MASSAGERESERVEPRICES_URL}/delete/${massageReservePricesId}`
  );
}
// DELETE MassageReservePrices by ids
export function deleteMassageReservePrices(ids) {
  return axios.post(
    `${MASSAGERESERVEPRICES_URL}/deleteMassageReservePrices`,
    ids
  );
}

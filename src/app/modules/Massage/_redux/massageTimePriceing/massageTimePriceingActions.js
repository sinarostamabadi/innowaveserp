...
import { massageTimePriceingSlice, callTypes } from "./massageTimePriceingSlice";
...
export const fetchMassageTimePriceing = (queryParams) => (dispatch) => {
  ...
  return requestFromServer  
    ...
    .then((response) => {
      ...
      dispatch(
        actions.massageTimePriceingFetched({ totalCount: TotalCount, entities: Items })  
      );
    })  
    .catch((error) => {
...
export const fetchMassageTimePriceing = (id) => (dispatch) => {
  if (!id) {
    return dispatch(actions.massageTimePriceingFetched({ massageTimePriceingForEdit: undefined }));
  }
  ...
  return requestFromServer  
    ...
    .then((response) => {
      ...
      dispatch(actions.massageTimePriceingFetched({ massageTimePriceingForEdit: massageTimePriceing }));
    })  
    .catch((error) => {
      error.clientMessage = "Can't find massageTimePriceing";
...
export const createMassageTimePriceing = (massageTimePriceingForCreation) => (dispatch) => {
  dispatch(actions.startCall({ callType: callTypes.action }));
  return requestFromServer  
...
export const updateMassageTimePriceing = (massageTimePriceing) => (dispatch) => {
  dispatch(actions.startCall({ callType: callTypes.action }));
  return requestFromServer  

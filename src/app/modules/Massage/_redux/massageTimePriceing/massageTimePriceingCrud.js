...
export function updateStatusForMassageTimePriceing(ids, status) {
  return axios.post(
    `${MASSAGETIMEPRICEING_URL}/updateStatusForMassageTimePriceing`,
    {
      ids,
      status,
    }
...
export function deleteMassageTimePriceing(massageTimePriceingId) {
  return axios.delete(
    `${MASSAGETIMEPRICEING_URL}/delete/${massageTimePriceingId}`
  );
}
// DELETE MassageTimePriceing by ids
export function deleteMassageTimePriceing(ids) {
  return axios.post(
    `${MASSAGETIMEPRICEING_URL}/deleteMassageTimePriceing`,
    ids
  );
}

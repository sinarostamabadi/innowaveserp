  ...
  return (
    <Suspense fallback={<LayoutSplashScreen />}>
      <Switch>
        ...
        <ContentRoute
          path="/Massage/massageCenters/new"
          component={MassageCenterEdit}
        />
        <ContentRoute
          path="/Massage/massageCenters/:id/edit"
          component={MassageCenterEdit}
        />
        <ContentRoute
          path="/Massage/massageCenters"
          component={MassageCentersPage}
        />
        {/* end MassageCenters */}

        {/* begin MassageDiscounts */}
        <ContentRoute
          path="/Massage/massageDiscounts/new"
          component={MassageDiscountEdit}
        />
        <ContentRoute
          path="/Massage/massageDiscounts/:id/edit"
          component={MassageDiscountEdit}
        />
        <ContentRoute
          path="/Massage/massageDiscounts"
          component={MassageDiscountsPage}
        />
        {/* end MassageDiscounts */}

        {/* begin MassageReserves */}
        <ContentRoute
          path="/Massage/massageReserves/new"
          component={MassageReserveEdit}
        />
        <ContentRoute
          path="/Massage/massageReserves/:id/edit"
          component={MassageReserveEdit}
        />
        <ContentRoute
          path="/Massage/massageReserves"
          component={MassageReservesPage}
        />
        {/* end MassageReserves */}

        {/* begin MassageReservePrices */}
        <ContentRoute
          path="/Massage/massageReservePrices/new"
          component={MassageReservePriceEdit}
        />
        <ContentRoute
          path="/Massage/massageReservePrices/:id/edit"
          component={MassageReservePriceEdit}
        />
        <ContentRoute
          path="/Massage/massageReservePrices"
          component={MassageReservePricesPage}
        />
        {/* end MassageReservePrices */}

        {/* begin MassageTimePriceing */}
        <ContentRoute
          path="/Massage/massageTimePriceing/new"
          component={MassageTimePriceingEdit}
        />
        <ContentRoute
          path="/Massage/massageTimePriceing/:id/edit"
          component={MassageTimePriceingEdit}
        />
        <ContentRoute
          path="/Massage/massageTimePriceing"
          component={MassageTimePriceingPage}
        />
        {/* end MassageTimePriceing */}

        {/* begin MassageTypes */}
        <ContentRoute
          path="/Massage/massageTypes/new"
          component={MassageTypeEdit}
        />
        <ContentRoute
          path="/Massage/massageTypes/:id/edit"
          component={MassageTypeEdit}
        />
        <ContentRoute
          path="/Massage/massageTypes"
        ...
        <ContentRoute
          path="/Massage/masseurs/:id/edit"
          component={MasseurEdit}
        />
        ...
        <ContentRoute
          path="/Massage/masseurMassageTypes/new"
          component={MasseurMassageTypeEdit}
        />
        <ContentRoute
          path="/Massage/masseurMassageTypes/:id/edit"
          component={MasseurMassageTypeEdit}
        />
        <ContentRoute
          path="/Massage/masseurMassageTypes"
          component={MasseurMassageTypesPage}
        />

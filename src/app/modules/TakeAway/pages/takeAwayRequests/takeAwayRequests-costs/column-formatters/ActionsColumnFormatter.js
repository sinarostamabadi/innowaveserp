...
export function ActionsColumnFormatter(
  ...
  row,
  rowIndex,
  { openEditCostDialog, openDeleteCostDialog, openSerialCostDialog, mode, t }
) {
  return (
    <>
      {/* {row.Product.HasSerial && (
        ...
        >
          <a
            ...
            onClick={() => openSerialCostDialog(row.TakeAwayRequestDtlId)}
          >
      ...
      >
        <a
          ...
          onClick={() => openEditCostDialog(row.TakeAwayRequestCostId, mode)}
        >
          <span className="svg-icon svg-icon-md svg-icon-primary">
            <SVG
      ...
      >
        <a
          ...
          onClick={() => {
            openDeleteCostDialog(row.TakeAwayRequestCostId);
          }}
        >

  ...
  return (
    <Suspense fallback={<LayoutSplashScreen />}>
      <Switch>
        ...
        <ContentRoute
          path="/Bowling/reserves/:id/edit"
          component={ReserveEdit}
        />
        <ContentRoute
          path="/Bowling/reserves/:id/replay"
          render={(props) => <ReserveEdit {...props} mode={"replay"} />}
        />
        <ContentRoute
          path="/Bowling/reserves/:id/editscore"
          component={ReserveEditScore}
        />
        <ContentRoute
          path="/Bowling/reserves/:id/score"
          component={ReserveScore}
        />
        ...
        {/* begin SetPricing */}
        <ContentRoute
          path="/Bowling/setPricing/new"
          component={SetPricingEdit}
        />
        <ContentRoute
          path="/Bowling/setPricing/:id/edit"
          component={SetPricingEdit}
        />
        ...
        {/* begin TimePriceings */}
        <ContentRoute
          path="/Bowling/timePriceing/new"
          component={TimePriceingEdit}
        />
        <ContentRoute
          path="/Bowling/timePriceing/:id/edit"
          component={TimePriceingEdit}
        />
        <ContentRoute
          path="/Bowling/timePriceing"
          component={TimePriceingPage}
        />
        {/* end TimePriceings */}

        {/* begin BowlingTeams */}
        <ContentRoute
          path="/Bowling/bowlingTeams/new"
          component={BowlingTeamEdit}
        />
        <ContentRoute
          path="/Bowling/bowlingTeams/:id/edit"
          component={BowlingTeamEdit}
        />
        <ContentRoute
          path="/Bowling/bowlingTeams"
          component={BowlingTeamsPage}
        />
        {/* end BowlingTeams */}

        {/* begin BowlingCompetitions */}
        <ContentRoute
          path="/Bowling/bowlingCompetitions/new"
          component={BowlingCompetitionEdit}
        />
        <ContentRoute
          path="/Bowling/bowlingCompetitions/:id/edit"
          component={BowlingCompetitionEdit}
        />
        <ContentRoute
          path="/Bowling/bowlingCompetitions/:id/standing"
          component={StandingTable}
        />
        <ContentRoute
          path="/Bowling/bowlingCompetitions"
          component={BowlingCompetitionsPage}
        />

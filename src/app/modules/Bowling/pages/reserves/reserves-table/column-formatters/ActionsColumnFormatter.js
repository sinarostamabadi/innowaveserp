  ...
  <>
      ...
      overlay={
        <Popover id="popover-basic" style={{ maxWidth: "300px" }}>
          <Popover.Content>
            ...
            <OverlayTrigger
              overlay={
                <Tooltip id="reserves-edit-tooltip">{t("Common.Show")}</Tooltip>
              }
            >
              <a
                className="btn btn-icon btn-light btn-hover-primary btn-sm mr-1"
                onClick={() =>
                  window.open(`/bowling/reserves/${row.ReserveId}/score`)
                }
              >
            ...
            <OverlayTrigger
              overlay={
                <Tooltip id="reserves-delete-tooltip">
                  {t("Common.Delete")}
                </Tooltip>
              }
            >
    ...
    >
      <Button
        ...
        variant="success"
      >
        <i className="fas fa-ellipsis-v text-success"></i>
      </Button>
    </OverlayTrigger>
    <OverlayTrigger

  ...
  return (
    <>
      <div ref={ref}>
                ...
                <tr>
                  ...
                  >
                    ...
                    {!!dataPrint && !!dataPrint.Param
                      ? (!!dataPrint.Param.FromDate ? dataPrint.Param.FromDate: " ")
                      : ""}
                  </td>
                  <td className="head">
                    <b>{t("Reports.FromDate")}:</b>{" "}
        ...
        {!!dataPrint &&
          dataPrint.FactorItems.length > 0 && (
            <div
              className="bill rtl"
              style={{
                direction: "rtl",
                        ...
                        >
                          <thead>
                            <tr className="text-center bg-black">
                              ...
                              <th>{t("Reports.BowlingInvoice.CountOfPlayers")}</th>
                          ...
                          <tbody style={{ backgroundColor: "white" }}>
                            ...
                            <tr>
                              <td className="text-center pr-3" colSpan="5">
                                ...
                                {numberWithCommas(dataPrint.FactorItems.map((x) => x.SumPrice)
                                  .reduce((a, b) => a + b))}
                              </td>
                            </tr>
                          </tbody>

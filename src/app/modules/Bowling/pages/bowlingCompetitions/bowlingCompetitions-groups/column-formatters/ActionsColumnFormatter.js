...
export function ActionsColumnFormatter(
  ...
  row,
  rowIndex,
  { openEditGroupDialog, openDeleteGroupDialog, openTeamGroupDialog, t }
) {
  return (
    <>
      <OverlayTrigger
      ...
      >
        <a
          ...
          onClick={() => openEditGroupDialog(row.BowlingCompetitionGroupId)}
        >
          <span className="svg-icon svg-icon-md svg-icon-primary">
            <SVG
      ...
      >
        <a
          ...
          onClick={() => {
            openDeleteGroupDialog(row.BowlingCompetitionGroupId);
          }}
        >

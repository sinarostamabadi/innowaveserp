...
export function updateStatusForCoreTransactionPlaces(ids, status) {
  return axios.post(`${CORETRANSACTIONPLACES_URL}/updateStatusForCoreTransactionPlaces`, {
    ids,
    status,
  });
}
...
export function deleteCoreTransactionPlace(coreTransactionPlacesId) {
  return axios.delete(`${CORETRANSACTIONPLACES_URL}/${coreTransactionPlacesId}`);
}
// DELETE CoreTransactionPlaces by ids  
export function deleteCoreTransactionPlaces(ids) {
return axios.post(`${CORETRANSACTIONPLACES_URL}/deleteCoreTransactionPlaces`, ids);
}

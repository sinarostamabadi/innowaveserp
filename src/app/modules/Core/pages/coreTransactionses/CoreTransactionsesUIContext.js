...
export const CoreTransactionsesUIConsumer =
  CoreTransactionsesUIContext.Consumer;
export function CoreTransactionsesUIProvider({
  coreTransactionsesUIEvents,
  children,
}) {
  const [queryParams, setQueryParamsBase] = useState(
    getConfig(CoreTransactionsModel).initialFilter
  );
  ...
  const value = {
    ...
    newCoreTransactionsButtonClick:
      coreTransactionsesUIEvents.newCoreTransactionsButtonClick,
    openEditCoreTransactionsPage:
      coreTransactionsesUIEvents.openEditCoreTransactionsPage,
    openDeleteCoreTransactionsDialog:
      coreTransactionsesUIEvents.openDeleteCoreTransactionsDialog,
    openDeleteCoreTransactionsesDialog:
      coreTransactionsesUIEvents.openDeleteCoreTransactionsesDialog,
    openFetchCoreTransactionsesDialog:
      coreTransactionsesUIEvents.openFetchCoreTransactionsesDialog,

...
export function CoreTransactionsesTable() {
  ...
  const coreTransactionsesUIProps = useMemo(() => {
    return {
      ...
      openDeleteCoreTransactionsDialog:
        coreTransactionsesUIContext.openDeleteCoreTransactionsDialog,
    };
  ...
  useEffect(() => {
    ...
    dispatch(
      actions.fetchCoreTransactionses(coreTransactionsesUIProps.queryParams)
    );
  ...
  const columns = [
    ...
    },
    {
      ...
      formatExtraData: {
        openEditCoreTransactionsPage:
          coreTransactionsesUIProps.openEditCoreTransactionsPage,
        openDeleteCoreTransactionsDialog:
          coreTransactionsesUIProps.openDeleteCoreTransactionsDialog,
      },

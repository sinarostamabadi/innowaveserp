...
export const CoreTransactionTypesUIConsumer =
  CoreTransactionTypesUIContext.Consumer;
export function CoreTransactionTypesUIProvider({
  coreTransactionTypesUIEvents,
  children,
}) {
  const [queryParams, setQueryParamsBase] = useState(
    getConfig(CoreTransactionTypeModel).initialFilter
  );
  ...
  const value = {
    ...
    newCoreTransactionTypeButtonClick:
      coreTransactionTypesUIEvents.newCoreTransactionTypeButtonClick,
    openEditCoreTransactionTypePage:
      coreTransactionTypesUIEvents.openEditCoreTransactionTypePage,
    openDeleteCoreTransactionTypeDialog:
      coreTransactionTypesUIEvents.openDeleteCoreTransactionTypeDialog,
    openDeleteCoreTransactionTypesDialog:
      coreTransactionTypesUIEvents.openDeleteCoreTransactionTypesDialog,
    openFetchCoreTransactionTypesDialog:
      coreTransactionTypesUIEvents.openFetchCoreTransactionTypesDialog,

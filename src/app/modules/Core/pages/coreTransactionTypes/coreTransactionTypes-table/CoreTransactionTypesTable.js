...
export function CoreTransactionTypesTable() {
  ...
  const coreTransactionTypesUIProps = useMemo(() => {
    return {
      ...
      openDeleteCoreTransactionTypeDialog:
        coreTransactionTypesUIContext.openDeleteCoreTransactionTypeDialog,
    };
  ...
  useEffect(() => {
    ...
    dispatch(
      actions.fetchCoreTransactionTypes(coreTransactionTypesUIProps.queryParams)
    );
  ...
  const columns = [
    ...
    },
    {
      ...
      formatExtraData: {
        openEditCoreTransactionTypePage:
          coreTransactionTypesUIProps.openEditCoreTransactionTypePage,
        openDeleteCoreTransactionTypeDialog:
          coreTransactionTypesUIProps.openDeleteCoreTransactionTypeDialog,
      },

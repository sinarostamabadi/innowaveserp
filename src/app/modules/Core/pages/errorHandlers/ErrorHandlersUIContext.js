...
export function ErrorHandlersUIProvider({ errorHandlersUIEvents, children }) {  
  const [queryParams, setQueryParamsBase] = useState(getConfig(ErrorHandlerModel).initialFilter);  
  ...
  const value = {  
    ...
    newErrorHandlerButtonClick: errorHandlersUIEvents.newErrorHandlerButtonClick,  
    openEditErrorHandlerPage: errorHandlersUIEvents.openEditErrorHandlerPage,  
    openDeleteErrorHandlerDialog: errorHandlersUIEvents.openDeleteErrorHandlerDialog,  
    openDeleteErrorHandlersDialog: errorHandlersUIEvents.openDeleteErrorHandlersDialog,  
    openFetchErrorHandlersDialog: errorHandlersUIEvents.openFetchErrorHandlersDialog,  

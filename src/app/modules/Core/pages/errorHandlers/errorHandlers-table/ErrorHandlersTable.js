...
export function ErrorHandlersTable() {  
  ...
  const errorHandlersUIProps = useMemo(() => {  
    return {  
      ...
      openDeleteErrorHandlerDialog: errorHandlersUIContext.openDeleteErrorHandlerDialog,  
    };  
  ...
  const columns = [  
    ...
    {  
      ...
      formatExtraData: {  
        ...
        openDeleteErrorHandlerDialog: errorHandlersUIProps.openDeleteErrorHandlerDialog,  
      },  

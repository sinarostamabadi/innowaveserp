...
export function RealPersonsUIProvider({ realPersonsUIEvents, children }) {  
  const [queryParams, setQueryParamsBase] = useState(getConfig(RealPersonModel).initialFilter);  
  ...
  const value = {  
    ...
    openDeleteRealPersonsDialog: realPersonsUIEvents.openDeleteRealPersonsDialog,  

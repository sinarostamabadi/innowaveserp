...
export function WalletsGrouping() {
  // Specs UI Context
  const specsUIContext = useWalletsUIContext();
          ...
          <div className="form-group form-group-inline">
            ...
            <div className="form-group-inline">
              <button
                ...
                onClick={specsUIProps.openDeleteWalletsDialog}
              >
              ...
              <button
                ...
                onClick={specsUIProps.openFetchWalletsDialog}
              >

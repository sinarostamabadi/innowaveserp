...
export function CoreTransactionPlacesTable() {
  ...
  const coreTransactionPlacesUIProps = useMemo(() => {
    return {
      ...
      openDeleteCoreTransactionPlaceDialog:
        coreTransactionPlacesUIContext.openDeleteCoreTransactionPlaceDialog,
    };
  ...
  const columns = [
    ...
    },
    {
      ...
      formatExtraData: {
        openEditCoreTransactionPlacePage:
          coreTransactionPlacesUIProps.openEditCoreTransactionPlacePage,
        openDeleteCoreTransactionPlaceDialog:
          coreTransactionPlacesUIProps.openDeleteCoreTransactionPlaceDialog,
      },

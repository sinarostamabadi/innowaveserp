...
export function CompanyTypesUIProvider({ companyTypesUIEvents, children }) {  
  const [queryParams, setQueryParamsBase] = useState(getConfig(CompanyTypeModel).initialFilter);  
  ...
  const value = {  
    ...
    openDeleteCompanyTypeDialog: companyTypesUIEvents.openDeleteCompanyTypeDialog,  
    openDeleteCompanyTypesDialog: companyTypesUIEvents.openDeleteCompanyTypesDialog,  
    openFetchCompanyTypesDialog: companyTypesUIEvents.openFetchCompanyTypesDialog,  

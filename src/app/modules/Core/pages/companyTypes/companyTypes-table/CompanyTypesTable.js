...
export function CompanyTypesTable() {  
  ...
  const companyTypesUIProps = useMemo(() => {  
    return {  
      ...
      openDeleteCompanyTypeDialog: companyTypesUIContext.openDeleteCompanyTypeDialog,  
    };  
  ...
  const columns = [  
    ...
    {  
      ...
      formatExtraData: {  
        ...
        openDeleteCompanyTypeDialog: companyTypesUIProps.openDeleteCompanyTypeDialog,  
      },  

...
export function updateAccountFloatingType(id, accountFloatingTypes) {
  return axios.put(`${ACCOUNTFLOATINGTYPES_URL}/put/${id}`, accountFloatingTypes);
}
// UPDATE Status  
export function updateStatusForAccountFloatingTypes(ids, status) {
  return axios.post(`${ACCOUNTFLOATINGTYPES_URL}/updateStatusForAccountFloatingTypes`, {
    ids,
    status,
  });
}
...
export function deleteAccountFloatingType(accountFloatingTypesId) {
  return axios.delete(`${ACCOUNTFLOATINGTYPES_URL}/delete/${accountFloatingTypesId}`);
}
// DELETE AccountFloatingTypes by ids  
export function deleteAccountFloatingTypes(ids) {
return axios.post(`${ACCOUNTFLOATINGTYPES_URL}/deleteAccountFloatingTypes`, ids);
}
...
const initialProfitLossItemsState = {
  ...
  totalCount: 0,
  entities: null,
  profitLossItemForEdit: undefined,
  lastError: null,
  error: null,
};
...
export const profitLossItemsSlice = createSlice({
  name: "profitLossItems",
  initialState: initialProfitLossItemsState,
  reducers: {
    ...
    profitLossItemsStatusUpdated: (state, action) => {
      ...
      state.entities = state.entities.map((entity) => {
        if (ids.findIndex((id) => id === entity.ProfitLossItemId) > -1) {

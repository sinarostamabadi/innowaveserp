...
export const fetchLinkDocuments = (queryParams) => (dispatch) => {
  ...
  return requestFromServer  
    ...
    .then((response) => {
      ...
      dispatch(
        actions.linkDocumentsFetched({ totalCount: TotalCount, entities: Items })  
      );
    })  
    .catch((error) => {
...
export const fetchLinkDocument = (id) => (dispatch) => {
  if (!id) {
    return dispatch(actions.linkDocumentFetched({ linkDocumentForEdit: undefined }));
  }
  ...
  return requestFromServer  
    ...
    .then((response) => {
      ...
      dispatch(actions.linkDocumentFetched({ linkDocumentForEdit: linkDocument }));
    })  
    .catch((error) => {

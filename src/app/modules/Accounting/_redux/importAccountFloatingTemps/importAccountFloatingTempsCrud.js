...
export function createImportAccountFloatingTemp(importAccountFloatingTemps) {
  return axios.post(
    `${IMPORTACCOUNTFLOATINGTEMPS_URL}/post`,
    importAccountFloatingTemps
  );
}
// READ
...
export function getImportAccountFloatingTempById(importAccountFloatingTempsId) {
  return axios.get(
    `${IMPORTACCOUNTFLOATINGTEMPS_URL}/get/${importAccountFloatingTempsId}`
  );
}
...
export function updateImportAccountFloatingTemp(
  id,
  importAccountFloatingTemps
) {
  return axios.put(
    `${IMPORTACCOUNTFLOATINGTEMPS_URL}/put/${id}`,
    importAccountFloatingTemps
  );
}
// UPDATE Status
export function updateStatusForImportAccountFloatingTemps(ids, status) {
  return axios.post(
    `${IMPORTACCOUNTFLOATINGTEMPS_URL}/updateStatusForImportAccountFloatingTemps`,
    {
      ids,
      status,
    }
...
export function deleteImportAccountFloatingTemp(importAccountFloatingTempsId) {
  return axios.delete(
    `${IMPORTACCOUNTFLOATINGTEMPS_URL}/delete/${importAccountFloatingTempsId}`
  );
}
// DELETE ImportAccountFloatingTemps by ids
export function deleteImportAccountFloatingTemps(ids) {
  return axios.post(
    `${IMPORTACCOUNTFLOATINGTEMPS_URL}/deleteImportAccountFloatingTemps`,
    ids
  );
}

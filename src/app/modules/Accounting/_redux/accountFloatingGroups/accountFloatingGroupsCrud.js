...
export function getAccountFloatingGroupById(accountFloatingGroupsId) {
  return axios.get(
    `${ACCOUNTFLOATINGGROUPS_URL}/get/${accountFloatingGroupsId}`
  );
}
...
export function updateAccountFloatingGroup(id, accountFloatingGroups) {
  return axios.put(
    `${ACCOUNTFLOATINGGROUPS_URL}/put/${id}`,
    accountFloatingGroups
  );
}
// UPDATE Status
export function updateStatusForAccountFloatingGroups(ids, status) {
  return axios.post(
    `${ACCOUNTFLOATINGGROUPS_URL}/updateStatusForAccountFloatingGroups`,
    {
      ids,
      status,
    }
...
export function deleteAccountFloatingGroup(accountFloatingGroupsId) {
  return axios.delete(
    `${ACCOUNTFLOATINGGROUPS_URL}/delete/${accountFloatingGroupsId}`
  );
}
// DELETE AccountFloatingGroups by ids
export function deleteAccountFloatingGroups(ids) {
  return axios.post(
    `${ACCOUNTFLOATINGGROUPS_URL}/deleteAccountFloatingGroups`,
    ids
  );
}

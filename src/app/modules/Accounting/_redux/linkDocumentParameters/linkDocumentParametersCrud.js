...
export function createLinkDocumentParameter(linkDocumentParameters) { 
  return axios.post(`${LINKDOCUMENTPARAMETERS_URL}/post`, linkDocumentParameters); 
}
// READ  
...
export function getLinkDocumentParameterById(linkDocumentParametersId) {
  return axios.get(`${LINKDOCUMENTPARAMETERS_URL}/get/${linkDocumentParametersId}`);
}
...
export function updateLinkDocumentParameter(id, linkDocumentParameters) {
  return axios.put(`${LINKDOCUMENTPARAMETERS_URL}/put/${id}`, linkDocumentParameters);
}
// UPDATE Status  
export function updateStatusForLinkDocumentParameters(ids, status) {
  return axios.post(`${LINKDOCUMENTPARAMETERS_URL}/updateStatusForLinkDocumentParameters`, {
    ids,
    status,
  });
}
...
export function deleteLinkDocumentParameter(linkDocumentParametersId) {
  return axios.delete(`${LINKDOCUMENTPARAMETERS_URL}/delete/${linkDocumentParametersId}`);
}
// DELETE LinkDocumentParameters by ids  
export function deleteLinkDocumentParameters(ids) {
return axios.post(`${LINKDOCUMENTPARAMETERS_URL}/deleteLinkDocumentParameters`, ids);
}
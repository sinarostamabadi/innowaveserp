...
export function updateStatusForImportDocumentTemps(ids, status) {
  return axios.post(
    `${IMPORTDOCUMENTTEMPS_URL}/updateStatusForImportDocumentTemps`,
    {
      ids,
      status,
    }
...
export function deleteImportDocumentTemp(importDocumentTempsId) {
  return axios.delete(
    `${IMPORTDOCUMENTTEMPS_URL}/delete/${importDocumentTempsId}`
  );
}
// DELETE ImportDocumentTemps by ids
export function deleteImportDocumentTemps(ids) {
  return axios.post(
    `${IMPORTDOCUMENTTEMPS_URL}/deleteImportDocumentTemps`,
    ids
  );
}

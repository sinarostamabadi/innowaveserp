...
export function createAccountFloatingGroupType(accountFloatingGroupTypes) {
  return axios.post(
    `${ACCOUNTFLOATINGGROUPTYPES_URL}/post`,
    accountFloatingGroupTypes
  );
}
// READ
...
export function getAccountFloatingGroupTypeById(accountFloatingGroupTypesId) {
  return axios.get(
    `${ACCOUNTFLOATINGGROUPTYPES_URL}/get/${accountFloatingGroupTypesId}`
  );
}
...
export function updateAccountFloatingGroupType(id, accountFloatingGroupTypes) {
  return axios.put(
    `${ACCOUNTFLOATINGGROUPTYPES_URL}/put/${id}`,
    accountFloatingGroupTypes
  );
}
// UPDATE Status
export function updateStatusForAccountFloatingGroupTypes(ids, status) {
  return axios.post(
    `${ACCOUNTFLOATINGGROUPTYPES_URL}/updateStatusForAccountFloatingGroupTypes`,
    {
      ids,
      status,
    }
...
export function deleteAccountFloatingGroupType(accountFloatingGroupTypesId) {
  return axios.delete(
    `${ACCOUNTFLOATINGGROUPTYPES_URL}/delete/${accountFloatingGroupTypesId}`
  );
}
// DELETE AccountFloatingGroupTypes by ids
export function deleteAccountFloatingGroupTypes(ids) {
  return axios.post(
    `${ACCOUNTFLOATINGGROUPTYPES_URL}/deleteAccountFloatingGroupTypes`,
    ids
  );
}

...
import { useDocumentDtlsUIContext, DocumentDtlsUIConsumer } from "./DocumentDtlsUIContext";
...
export function DocumentDtlsCard() {
  ...
  const documentDtlsUIProps = useMemo(() => {
    return {
      ...
      newDocumentDtlButtonClick: documentDtlsUIContext.newDocumentDtlButtonClick,
      openDeleteDocumentDtlsDialog: documentDtlsUIContext.openDeleteDocumentDtlsDialog,
      openEditDocumentDtlPage: documentDtlsUIContext.openEditDocumentDtlPage,
      openUpdateDocumentDtlsStatusDialog: documentDtlsUIContext.openUpdateDocumentDtlsStatusDialog,
      openFetchDocumentDtlsDialog: documentDtlsUIContext.openFetchDocumentDtlsDialog,
    };

...
export function AccountFloatingTypeEditForm({ accountFloatingType, btnRef, saveAccountFloatingType }) {
  ...
  useEffect(() => {
    ...
    setParentIds((lines) => [
          ...
          ...data.Items.filter( x => x.CostCenterId != accountFloatingType.AccountFloatingTypeId),
        ])
      );
                ...
                <Select
                    ...
                    >
                      {parentIds.map((parent) => (
                        <option key={parent.AccountFloatingTypeId} value={parent.AccountFloatingTypeId}>
                          {parent.Title}
                        </option>
                      ))}
                    </Select>

...
import DefaultWarehouse from "../../Warehouse/dashboard/boards/DefaultWarehouse";
        ...
        <div className="col-12" style={{ minHeight: "100%" }}>
          ...
          >
            ...
            <div className="card-body">
              <ServiceAccessShow dashboardId="1022"></ServiceAccessShow>

              <img
                alt="logo"
                src="/media/modules/purchaseorder.png"
                style={{
                  position: "absolute",
                  bottom: "1rem",
                  left: "1rem",

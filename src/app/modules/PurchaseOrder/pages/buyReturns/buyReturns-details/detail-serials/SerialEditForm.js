...
export function SerialEditForm({ detail, actionsLoading, onHide }) {
  ...
  const BuyReturnSerialEditSchema = Yup.object().shape({
    SerialNo: Yup.string()
      .min(2, t("err.Min", { 0: 2 }))
      ...
      .required(t("err.IsRequired", { 0: t("BuyReturnSerial.SerialNumber") })),
  });

  const columns = [
    {
      dataField: "SerialNumber",
      text: t("BuyReturnSerial.SerialNumber"),
      sort: false,
    },
    {
      dataField: "action",
  ...
  function addSerial(values) {
    detailsUIProps.addSerial({
      BuyReturnSerialId: "",
      BuyReturnDetailId: detailsUIProps.selectedItem.BuyReturnDetailId,
        ...
        <Row>
          <Col>
            <Formik
              ...
              validationSchema={BuyReturnSerialEditSchema}
              onSubmit={(values) => {
                  ...
                  <Row>
                    <Col>
                      <Field
                        ...
                        component={Input}
                        customFeedbackLabel=""
                        label={t("BuyReturnSerial.SerialNumber")}
                        setref={defaultInput}
                        onKeyPress={(e) => {
                          if (e.key === "Enter") {
                            e.stopPropagation();
        ...
        <Row>
          <Col>
            <BootstrapTable
              ...
              bootstrap4
              remote
              keyField="BuyReturnSerialId"
              data={
                detailsUIProps.selectedItem.BuyReturnSerials === null
                  ? []
            ...
            >
              <PleaseWaitMessage
                entities={detailsUIProps.selectedItem.BuyReturnSerials}
              />
              <NoRecordsFoundMessage
                entities={detailsUIProps.selectedItem.BuyReturnSerials}
              />

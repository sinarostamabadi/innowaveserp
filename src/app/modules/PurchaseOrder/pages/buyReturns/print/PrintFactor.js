        ...
        <div style={{ margin: "2rem" }}>
          {!!dataPrint == true ? (
            <>
              ...
              <table className="buyReturn-table" style={{width: "100%"}}>
                <thead>
                  <tr>
                    <th>ردیف</th>
                    <th>نام</th>
                ...
                <tbody>
                  {dataPrint.BuyReturnDetails.map((x, i) => (
                    <tr>
                  ...
                  <tr>
                    ...
                    <td colSpan="2">
                      {numberWithCommas(
                        dataPrint.BuyReturnDetails.map((x) => x.Amount).reduce(
                          (a, b) => a + b
                        )
                      )}
                    </td>

...
export function ActionsColumnFormatter(
  ...
  row,
  rowIndex,
  { openEditDiscountDialog, openDeleteDiscountDialog, t }
) {
  return (
    <>
      <OverlayTrigger
      ...
      >
        <a
          ...
          onClick={() => openEditDiscountDialog(row.BuyReturnDiscountId)}
        >
      ...
      >
        <a
          ...
          onClick={() => {
            openDeleteDiscountDialog(row.BuyReturnDiscountId);
          }}
        >

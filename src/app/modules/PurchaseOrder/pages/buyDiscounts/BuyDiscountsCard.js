...
import {
  useBuyDiscountsUIContext,
  BuyDiscountsUIConsumer,
} from "./BuyDiscountsUIContext";
  ...
  const buyDiscountsUIProps = useMemo(() => {
    return {
      ...
      newBuyDiscountButtonClick:
        buyDiscountsUIContext.newBuyDiscountButtonClick,
      openDeleteBuyDiscountsDialog:
        buyDiscountsUIContext.openDeleteBuyDiscountsDialog,
      openEditBuyDiscountPage: buyDiscountsUIContext.openEditBuyDiscountPage,
      openUpdateBuyDiscountsStatusDialog:
        buyDiscountsUIContext.openUpdateBuyDiscountsStatusDialog,
      openFetchBuyDiscountsDialog:
        buyDiscountsUIContext.openFetchBuyDiscountsDialog,
    };

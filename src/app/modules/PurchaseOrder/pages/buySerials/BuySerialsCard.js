...
import { useBuySerialsUIContext, BuySerialsUIConsumer } from "./BuySerialsUIContext";
...
export function BuySerialsCard() {
  ...
  const buySerialsUIProps = useMemo(() => {
    return {
      ...
      openDeleteBuySerialsDialog: buySerialsUIContext.openDeleteBuySerialsDialog,
      openEditBuySerialPage: buySerialsUIContext.openEditBuySerialPage,
      openUpdateBuySerialsStatusDialog: buySerialsUIContext.openUpdateBuySerialsStatusDialog,

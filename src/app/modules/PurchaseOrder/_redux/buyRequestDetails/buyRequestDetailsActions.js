...
export const fetchBuyRequestDetails = (queryParams) => (dispatch) => {
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.buyRequestDetailsFetched({
...
export const fetchBuyRequestDetail = (id) => (dispatch) => {
  if (!id) {
    return dispatch(
      actions.buyRequestDetailFetched({ buyRequestDetailForEdit: undefined })
    );
  }
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.buyRequestDetailFetched({
          buyRequestDetailForEdit: buyRequestDetail,
        })
      );
    })
    .catch((error) => {
...
export const createBuyRequestDetail =
  (buyRequestDetailForCreation) => (dispatch) => {
    dispatch(actions.startCall({ callType: callTypes.action }));
    return requestFromServer

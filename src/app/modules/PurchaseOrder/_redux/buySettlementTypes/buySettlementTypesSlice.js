...
const initialBuySettlementTypesState = {
  ...
  totalCount: 0,
  entities: null,
  buySettlementTypeForEdit: undefined,
  lastError: null,
  error: null,
};
...
export const buySettlementTypesSlice = createSlice({
  name: "buySettlementTypes",
  initialState: initialBuySettlementTypesState,
  reducers: {
    ...
    buySettlementTypesStatusUpdated: (state, action) => {
      ...
      state.entities = state.entities.map((entity) => {
        if (ids.findIndex((id) => id === entity.BuySettlementTypeId) > -1) {

...
import DefaultWarehouse from "./boards/DefaultWarehouse";
import DefaultYear from "./boards/DefaultYear";
        ...
        <div className="col-12" style={{ minHeight: "500px" }}>
          ...
          >
            ...
            <div className="card-body">
              <ServiceAccessShow dashboardId="1023"></ServiceAccessShow>

              <img
                alt="logo"
                src="/media/modules/warehouse.png"
                style={{
                  position: "absolute",
                  bottom: "1rem",
                  left: "1rem",

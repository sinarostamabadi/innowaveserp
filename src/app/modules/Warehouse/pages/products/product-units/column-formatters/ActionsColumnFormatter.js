...
export function ActionsColumnFormatter(
  ...
  row,
  rowIndex,
  { openEditProductUnitDialog, openDeleteProductUnitDialog, t }
) {
  return (
    <>
      <OverlayTrigger
      ...
      >
        <a
          ...
          onClick={() => openEditProductUnitDialog(row.ProductUnitId)}
        >
      ...
      >
        <a
          ...
          onClick={() => {
            openDeleteProductUnitDialog(row.ProductUnitId);
          }}
        >

...
export function ActionsColumnFormatter(
  ...
  row,
  rowIndex,
  { openEditProductWarehouseDialog, openDeleteProductWarehouseDialog, t }
) {
  return (
    <>
      <OverlayTrigger
      ...
      >
        <a
          ...
          onClick={() => openEditProductWarehouseDialog(row.ProductWarehouseId)}
        >
      ...
      >
        <a
          ...
          onClick={() => {
            openDeleteProductWarehouseDialog(row.ProductWarehouseId);
          }}
        >

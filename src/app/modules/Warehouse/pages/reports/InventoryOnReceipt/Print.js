  ...
  return (
    <>
      <div ref={ref} style={{ margin: "1rem" }}>
        ...
        <table
          className="InventoryOnReceipt-detail table table-bordered border-dark"
          style={{
            borderSpacing: "0",
            direction: "rtl",
            width: "100%",
        ...
        >
          <thead style={{ backgroundColor: "#ccc" }}>
            <tr>
              ...
              <th className="border-dark" style={{ width: "50%" }}>
                نام كالا
              </th>
              ...
              dataPrint.Items.map((x, i) => (
                <>
                  <tr>
                    ...
                    <td className="border-dark ltr text-center">{x.ReceiptNo}</td>

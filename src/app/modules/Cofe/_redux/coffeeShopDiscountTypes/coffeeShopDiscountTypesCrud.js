...
export function createCoffeeShopDiscountType(coffeeShopDiscountTypes) { 
  return axios.post(`${COFFEESHOPDISCOUNTTYPES_URL}/post`, coffeeShopDiscountTypes); 
}
// READ  
...
export function getCoffeeShopDiscountTypeById(coffeeShopDiscountTypesId) {
  return axios.get(`${COFFEESHOPDISCOUNTTYPES_URL}/get/${coffeeShopDiscountTypesId}`);
}
...
export function updateCoffeeShopDiscountType(id, coffeeShopDiscountTypes) {
  return axios.put(`${COFFEESHOPDISCOUNTTYPES_URL}/put/${id}`, coffeeShopDiscountTypes);
}
// UPDATE Status  
export function updateStatusForCoffeeShopDiscountTypes(ids, status) {
  return axios.post(`${COFFEESHOPDISCOUNTTYPES_URL}/updateStatusForCoffeeShopDiscountTypes`, {
    ids,
    status,
  });
}
...
export function deleteCoffeeShopDiscountType(coffeeShopDiscountTypesId) {
  return axios.delete(`${COFFEESHOPDISCOUNTTYPES_URL}/delete/${coffeeShopDiscountTypesId}`);
}
// DELETE CoffeeShopDiscountTypes by ids  
export function deleteCoffeeShopDiscountTypes(ids) {
return axios.post(`${COFFEESHOPDISCOUNTTYPES_URL}/deleteCoffeeShopDiscountTypes`, ids);
}
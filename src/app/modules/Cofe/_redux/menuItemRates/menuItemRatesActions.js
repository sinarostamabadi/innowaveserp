...
export const fetchMenuItemRates = (queryParams) => (dispatch) => {
  ...
  return requestFromServer  
    ...
    .then((response) => {
      ...
      dispatch(
        actions.menuItemRatesFetched({ totalCount: TotalCount, entities: Items })  
      );
    })  
    .catch((error) => {
...
export const fetchMenuItemRate = (id) => (dispatch) => {
  if (!id) {
    return dispatch(actions.menuItemRateFetched({ menuItemRateForEdit: undefined }));
  }
  ...
  return requestFromServer  
    ...
    .then((response) => {
      ...
      dispatch(actions.menuItemRateFetched({ menuItemRateForEdit: menuItemRate }));
    })  
    .catch((error) => {

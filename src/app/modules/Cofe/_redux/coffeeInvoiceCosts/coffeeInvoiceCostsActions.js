...
export const fetchCoffeeInvoiceCosts = (queryParams) => (dispatch) => {
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.coffeeInvoiceCostsFetched({
...
export const fetchCoffeeInvoiceCost = (id) => (dispatch) => {
  if (!id) {
    return dispatch(
      actions.coffeeInvoiceCostFetched({ coffeeInvoiceCostForEdit: undefined })
    );
  }
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.coffeeInvoiceCostFetched({
          coffeeInvoiceCostForEdit: coffeeInvoiceCost,
        })
      );
    })
    .catch((error) => {
...
export const createCoffeeInvoiceCost =
  (coffeeInvoiceCostForCreation) => (dispatch) => {
    dispatch(actions.startCall({ callType: callTypes.action }));
    return requestFromServer

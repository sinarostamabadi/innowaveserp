...
export const coffeeShopCostTypesSlice = createSlice({
  name: "coffeeShopCostTypes",
  initialState: initialCoffeeShopCostTypesState,
  reducers: {
    ...
    coffeeShopCostTypesStatusUpdated: (state, action) => {
      ...
      state.entities = state.entities.map((entity) => {
        if (ids.findIndex((id) => id === entity.CoffeeShopCostTypeId) > -1) {

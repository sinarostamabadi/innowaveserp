...
export function updateStatusForCoffeeShopCostTypes(ids, status) {
  return axios.post(
    `${COFFEESHOPCOSTTYPES_URL}/updateStatusForCoffeeShopCostTypes`,
    {
      ids,
      status,
    }
...
export function deleteCoffeeShopCostType(coffeeShopCostTypesId) {
  return axios.delete(
    `${COFFEESHOPCOSTTYPES_URL}/delete/${coffeeShopCostTypesId}`
  );
}
// DELETE CoffeeShopCostTypes by ids
export function deleteCoffeeShopCostTypes(ids) {
  return axios.post(
    `${COFFEESHOPCOSTTYPES_URL}/deleteCoffeeShopCostTypes`,
    ids
  );
}

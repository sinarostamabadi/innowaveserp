...
export function getMenuItemIngredientsById(menuItemIngredientsesId) {
  return axios.get(
    `${MENUITEMINGREDIENTSES_URL}/get/${menuItemIngredientsesId}`
  );
}
...
export function updateMenuItemIngredients(id, menuItemIngredientses) {
  return axios.put(
    `${MENUITEMINGREDIENTSES_URL}/put/${id}`,
    menuItemIngredientses
  );
}
// UPDATE Status
export function updateStatusForMenuItemIngredientses(ids, status) {
  return axios.post(
    `${MENUITEMINGREDIENTSES_URL}/updateStatusForMenuItemIngredientses`,
    {
      ids,
      status,
    }
...
export function deleteMenuItemIngredients(menuItemIngredientsesId) {
  return axios.delete(
    `${MENUITEMINGREDIENTSES_URL}/delete/${menuItemIngredientsesId}`
  );
}
// DELETE MenuItemIngredientses by ids
export function deleteMenuItemIngredientses(ids) {
  return axios.post(
    `${MENUITEMINGREDIENTSES_URL}/deleteMenuItemIngredientses`,
    ids
  );
}

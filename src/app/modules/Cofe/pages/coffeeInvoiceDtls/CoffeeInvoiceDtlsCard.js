...
import {
  useCoffeeInvoiceDtlsUIContext,
  CoffeeInvoiceDtlsUIConsumer,
} from "./CoffeeInvoiceDtlsUIContext";
  ...
  const coffeeInvoiceDtlsUIProps = useMemo(() => {
    return {
      ...
      newCoffeeInvoiceDtlButtonClick:
        coffeeInvoiceDtlsUIContext.newCoffeeInvoiceDtlButtonClick,
      openDeleteCoffeeInvoiceDtlsDialog:
        coffeeInvoiceDtlsUIContext.openDeleteCoffeeInvoiceDtlsDialog,
      ...
      openUpdateCoffeeInvoiceDtlsStatusDialog:
        coffeeInvoiceDtlsUIContext.openUpdateCoffeeInvoiceDtlsStatusDialog,
      openFetchCoffeeInvoiceDtlsDialog:
        coffeeInvoiceDtlsUIContext.openFetchCoffeeInvoiceDtlsDialog,
    };

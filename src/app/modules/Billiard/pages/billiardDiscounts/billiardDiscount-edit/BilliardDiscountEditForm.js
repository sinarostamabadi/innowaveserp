  ...
  return (
    <>
      <Formik
        ...
        initialValues={billiardDiscount}
        validationSchema={BilliardDiscountEditSchema}
        onSubmit={(values) => {
          saveBilliardDiscount(values);
        }}
      >
        {({ handleSubmit }) => (
          <>
              ...
              <div className="form-group row">
                <div className="col-lg-6">
                  <Field
                    ...
                    component={Input}
                    customFeedbackLabel=""
                    label={t("BilliardDiscount.TitleFa")}
                  />
                </div>
                <div className="col-lg-6">
                  <Field
                    ...
                    component={Input}
                    customFeedbackLabel=""
                    label={t("BilliardDiscount.TitleEn")}
                  />
                </div>
              </div>
              <button

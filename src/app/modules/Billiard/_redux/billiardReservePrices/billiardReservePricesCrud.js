...
export function getBilliardReservePriceById(billiardReservePricesId) {
  return axios.get(`${BILLIARDRESERVEPRICES_URL}/get/${billiardReservePricesId}`);
}
...
export function updateBilliardReservePrice(id, billiardReservePrices) {
  return axios.put(`${BILLIARDRESERVEPRICES_URL}/put/${id}`, billiardReservePrices);
}
// UPDATE Status  
export function updateStatusForBilliardReservePrices(ids, status) {
  return axios.post(`${BILLIARDRESERVEPRICES_URL}/updateStatusForBilliardReservePrices`, {
    ids,
    status,
  });
}
...
export function deleteBilliardReservePrice(billiardReservePricesId) {
  return axios.delete(`${BILLIARDRESERVEPRICES_URL}/delete/${billiardReservePricesId}`);
}
// DELETE BilliardReservePrices by ids  
export function deleteBilliardReservePrices(ids) {
return axios.post(`${BILLIARDRESERVEPRICES_URL}/deleteBilliardReservePrices`, ids);
}
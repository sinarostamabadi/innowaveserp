...
import { billiardTimePriceingSlice, callTypes } from "./billiardTimePriceingSlice";
...
export const fetchBilliardTimePriceing = (queryParams) => (dispatch) => {
  ...
  return requestFromServer  
    ...
    .then((response) => {
      ...
      dispatch(
        actions.billiardTimePriceingFetched({ totalCount: TotalCount, entities: Items })  
      );
    })  
    .catch((error) => {
...
export const fetchBilliardTimePriceing = (id) => (dispatch) => {
  if (!id) {
    return dispatch(actions.billiardTimePriceingFetched({ billiardTimePriceingForEdit: undefined }));
  }
  ...
  return requestFromServer  
    ...
    .then((response) => {
      ...
      dispatch(actions.billiardTimePriceingFetched({ billiardTimePriceingForEdit: billiardTimePriceing }));
    })  
    .catch((error) => {
      error.clientMessage = "Can't find billiardTimePriceing";
...
export const createBilliardTimePriceing = (billiardTimePriceingForCreation) => (dispatch) => {
  dispatch(actions.startCall({ callType: callTypes.action }));
  return requestFromServer  
...
export const updateBilliardTimePriceing = (billiardTimePriceing) => (dispatch) => {
  dispatch(actions.startCall({ callType: callTypes.action }));
  return requestFromServer  

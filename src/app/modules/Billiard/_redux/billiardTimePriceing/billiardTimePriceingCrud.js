...
export function updateBilliardTimePriceing(id, billiardTimePriceing) {
  return axios.put(`${BILLIARDTIMEPRICEING_URL}/put/${id}`, billiardTimePriceing);
}
// UPDATE Status  
export function updateStatusForBilliardTimePriceing(ids, status) {
  return axios.post(`${BILLIARDTIMEPRICEING_URL}/updateStatusForBilliardTimePriceing`, {
    ids,
    status,
  });
}
...
export function deleteBilliardTimePriceing(billiardTimePriceingId) {
  return axios.delete(`${BILLIARDTIMEPRICEING_URL}/delete/${billiardTimePriceingId}`);
}
// DELETE BilliardTimePriceing by ids  
export function deleteBilliardTimePriceing(ids) {
return axios.post(`${BILLIARDTIMEPRICEING_URL}/deleteBilliardTimePriceing`, ids);
}
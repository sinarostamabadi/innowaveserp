...
export function ActionsColumnFormatter(
  ...
  row,
  rowIndex,
  { openEditDetailDialog, openDeleteDetailDialog, openSerialDetailDialog, mode, t }
) {
  return (
    <>
      {/* {row.Product.HasSerial && (
        ...
        >
          <a
            ...
            onClick={() => openSerialDetailDialog(row.SellDiscountDtlId)}
          >
      ...
      >
        <a
          ...
          onClick={() => openEditDetailDialog(row.SellDiscountDetailId, mode)}
        >
          <span className="svg-icon svg-icon-md svg-icon-primary">
            <SVG
      ...
      >
        <a
          ...
          onClick={() => {
            openDeleteDetailDialog(row.SellDiscountDetailId);
          }}
        >

...
console.log("detail > ", detail);
  ...
  function cleanDetail(dirtyData) {
    return {
      SellDiscountDetailId: dirtyData.SellDiscountDetailId,
      SellDiscountId: dirtyData.SellDiscountId,
      ...
      IsDeleted: false,
      SellDiscountDetailInfos: dirtyData.SellDiscountDetailInfos,
    };
  }
          ...
          <>
            <Modal.Body className="">
              ...
              <Form className="form form-label-right">
                ...
                {detailsUIProps.mode == 1 && (
                  <>
                    <div className="col-lg-4">
                      <Field
                        name="FromPrice"
                        component={Input}
                        label={t("SellDiscountDetail.FromPrice")}
                      />
                    </div>
                    <div className="col-lg-4">
                      <Field
                        name="ToPrice"
                        component={Input}
                        label={t("SellDiscountDetail.ToPrice")}
                      />
                    </div>
                    <div className="col-lg-4">
                      <Field
                        ...
                        component={Input}
                        label={t("SellDiscountDetail.DiscountPercent")}
                      />
                    </div>
                  </>
                )}
                {detailsUIProps.mode == 2 && (
                  <>
                    <div className="col-lg-4">
                      <Field
                        name="FromAmount"
                        component={Input}
                        label={t("SellDiscountDetail.FromAmount")}
                      />
                    </div>
                    <div className="col-lg-4">
                      <Field
                        name="ToAmount"
                        component={Input}
                        label={t("SellDiscountDetail.ToAmount")}
                      />
                    </div>
                    <div className="col-lg-4">
                      <Field
                        name="RewardAmount"
                        component={Input}
                        label={t("SellDiscountDetail.RewardAmount")}
                      />
                    </div>
                  </>
                )}

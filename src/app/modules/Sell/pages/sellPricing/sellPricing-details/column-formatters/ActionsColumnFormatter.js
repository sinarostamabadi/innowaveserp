...
export function ActionsColumnFormatter(
  ...
  row,
  rowIndex,
  { openEditSellPricingDetailDialog, openDeleteSellPricingDetailDialog, t }
) {
  return (
    <>
      <OverlayTrigger
      ...
      >
        <a
          ...
          onClick={() => openEditSellPricingDetailDialog(row.SellPricingDetailId)}
        >
      ...
      >
        <a
          ...
          onClick={() => {
            openDeleteSellPricingDetailDialog(row.SellPricingDetailId);
          }}
        >

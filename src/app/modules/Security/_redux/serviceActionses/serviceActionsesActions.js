...
export const fetchServiceActionses = (queryParams) => (dispatch) => {
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.serviceActionsesFetched({
...
export const fetchServiceActions = (id) => (dispatch) => {
  if (!id) {
    return dispatch(
      actions.serviceActionsFetched({ serviceActionsForEdit: undefined })
    );
  }
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.serviceActionsFetched({ serviceActionsForEdit: serviceActions })
      );
    })
    .catch((error) => {
...
export const createServiceActions =
  (serviceActionsForCreation) => (dispatch) => {
    dispatch(actions.startCall({ callType: callTypes.action }));
    return requestFromServer

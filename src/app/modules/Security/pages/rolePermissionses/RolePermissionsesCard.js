...
import {
  useRolePermissionsesUIContext,
  RolePermissionsesUIConsumer,
} from "./RolePermissionsesUIContext";
  ...
  const rolePermissionsesUIProps = useMemo(() => {
    return {
      ...
      newRolePermissionsButtonClick:
        rolePermissionsesUIContext.newRolePermissionsButtonClick,
      openDeleteRolePermissionsesDialog:
        rolePermissionsesUIContext.openDeleteRolePermissionsesDialog,
      openEditRolePermissionsPage:
        rolePermissionsesUIContext.openEditRolePermissionsPage,
      openUpdateRolePermissionsesStatusDialog:
        rolePermissionsesUIContext.openUpdateRolePermissionsesStatusDialog,
      openFetchRolePermissionsesDialog:
        rolePermissionsesUIContext.openFetchRolePermissionsesDialog,
    };

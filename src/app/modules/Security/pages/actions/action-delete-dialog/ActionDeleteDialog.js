...
export function ActionDeleteDialog({ id, show, onHide }) {
  ...
  const { isLoading } = useSelector(
    (state) => ({ isLoading: state.actions.actionsLoading }),
    shallowEqual
  );
  ...
  const deleteAction = () => {
    // server request for deleting action by id
  ...
  return (
    ...
    >
      ...
      <Modal.Header closeButton>
        <Modal.Title id="example-modal-sizes-title-lg">{t("Common.Delete") + " " + t("Action.Entity")}</Modal.Title>
      </Modal.Header>
      <Modal.Body>

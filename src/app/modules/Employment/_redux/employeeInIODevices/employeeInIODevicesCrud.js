...
export function updateStatusForEmployeeInIODevices(ids, status) {
  return axios.post(`${EMPLOYEEINIODEVICES_URL}/updateStatusForEmployeeInIODevices`, {
    ids,
    status,
  });
}
...
export function deleteEmployeeInIODevice(employeeInIODevicesId) {
  return axios.delete(`${EMPLOYEEINIODEVICES_URL}/delete/${employeeInIODevicesId}`);
}
// DELETE EmployeeInIODevices by ids  
export function deleteEmployeeInIODevices(ids) {
return axios.post(`${EMPLOYEEINIODEVICES_URL}/deleteEmployeeInIODevices`, ids);
}
...
export const employeeInIODevicesSlice = createSlice({
  ...
  reducers: {
    ...
    employeeInIODeviceFetched: (state, action) => {
      state.actionsLoading = false;
      state.employeeInIODeviceForEdit = action.payload.employeeInIODeviceForEdit;
      state.error = null;
    },
    ...
    employeeInIODeviceUpdated: (state, action) => {
      ...
      state.entities = state.entities.map((entity) => {
        if (entity.EmployeeInIODeviceId === action.payload.employeeInIODevice.EmployeeInIODeviceId) {

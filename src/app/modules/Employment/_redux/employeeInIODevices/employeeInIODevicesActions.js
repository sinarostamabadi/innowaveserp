...
import {
  employeeInIODevicesSlice,
  callTypes,
} from "./employeeInIODevicesSlice";
...
export const fetchEmployeeInIODevices = (queryParams) => (dispatch) => {
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.employeeInIODevicesFetched({
...
export const fetchEmployeeInIODevice = (id) => (dispatch) => {
  if (!id) {
    return dispatch(
      actions.employeeInIODeviceFetched({
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.employeeInIODeviceFetched({
          employeeInIODeviceForEdit: employeeInIODevice,
        })
      );
    })
    .catch((error) => {
...
export const createEmployeeInIODevice =
  (employeeInIODeviceForCreation) => (dispatch) => {
    dispatch(actions.startCall({ callType: callTypes.action }));
    return requestFromServer

...
export function createEmployeeWorkExperience(employeeWorkExperiences) { 
  return axios.post(`${EMPLOYEEWORKEXPERIENCES_URL}/post`, employeeWorkExperiences); 
}
// READ  
...
export function getEmployeeWorkExperienceById(employeeWorkExperiencesId) {
  return axios.get(`${EMPLOYEEWORKEXPERIENCES_URL}/get/${employeeWorkExperiencesId}`);
}
...
export function updateEmployeeWorkExperience(id, employeeWorkExperiences) {
  return axios.put(`${EMPLOYEEWORKEXPERIENCES_URL}/put/${id}`, employeeWorkExperiences);
}
// UPDATE Status  
export function updateStatusForEmployeeWorkExperiences(ids, status) {
  return axios.post(`${EMPLOYEEWORKEXPERIENCES_URL}/updateStatusForEmployeeWorkExperiences`, {
    ids,
    status,
  });
}
...
export function deleteEmployeeWorkExperience(employeeWorkExperiencesId) {
  return axios.delete(`${EMPLOYEEWORKEXPERIENCES_URL}/delete/${employeeWorkExperiencesId}`);
}
// DELETE EmployeeWorkExperiences by ids  
export function deleteEmployeeWorkExperiences(ids) {
return axios.post(`${EMPLOYEEWORKEXPERIENCES_URL}/deleteEmployeeWorkExperiences`, ids);
}
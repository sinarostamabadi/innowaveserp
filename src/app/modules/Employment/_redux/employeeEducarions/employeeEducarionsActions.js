...
export const fetchEmployeeEducarions = (queryParams) => (dispatch) => {
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.employeeEducarionsFetched({
...
export const fetchEmployeeEducarion = (id) => (dispatch) => {
  if (!id) {
    return dispatch(
      actions.employeeEducarionFetched({ employeeEducarionForEdit: undefined })
    );
  }
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.employeeEducarionFetched({
          employeeEducarionForEdit: employeeEducarion,
        })
      );
    })
    .catch((error) => {
...
export const createEmployeeEducarion =
  (employeeEducarionForCreation) => (dispatch) => {
    dispatch(actions.startCall({ callType: callTypes.action }));
    return requestFromServer

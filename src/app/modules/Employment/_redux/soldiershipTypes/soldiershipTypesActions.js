...
export const fetchSoldiershipTypes = (queryParams) => (dispatch) => {
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.soldiershipTypesFetched({
...
export const fetchSoldiershipType = (id) => (dispatch) => {
  if (!id) {
    return dispatch(
      actions.soldiershipTypeFetched({ soldiershipTypeForEdit: undefined })
    );
  }
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.soldiershipTypeFetched({
          soldiershipTypeForEdit: soldiershipType,
        })
      );
    })
    .catch((error) => {
...
export const createSoldiershipType =
  (soldiershipTypeForCreation) => (dispatch) => {
    dispatch(actions.startCall({ callType: callTypes.action }));
    return requestFromServer

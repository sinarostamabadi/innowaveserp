...
const initialEmployeeMissionsState = {
  ...
  totalCount: 0,
  entities: null,
  employeeMissionForEdit: undefined,
  lastError: null,
  error: null,
};
...
export const employeeMissionsSlice = createSlice({
  name: "employeeMissions",
  initialState: initialEmployeeMissionsState,
  reducers: {
    ...
    employeeMissionsStatusUpdated: (state, action) => {
      ...
      state.entities = state.entities.map((entity) => {
        if (ids.findIndex((id) => id === entity.EmployeeMissionId) > -1) {

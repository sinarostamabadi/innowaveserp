...
export const fetchEmployeeMissions = (queryParams) => (dispatch) => {
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.employeeMissionsFetched({
...
export const fetchEmployeeMission = (id) => (dispatch) => {
  if (!id) {
    return dispatch(
      actions.employeeMissionFetched({ employeeMissionForEdit: undefined })
    );
  }
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.employeeMissionFetched({
          employeeMissionForEdit: employeeMission,
        })
      );
    })
    .catch((error) => {
...
export const createEmployeeMission =
  (employeeMissionForCreation) => (dispatch) => {
    dispatch(actions.startCall({ callType: callTypes.action }));
    return requestFromServer

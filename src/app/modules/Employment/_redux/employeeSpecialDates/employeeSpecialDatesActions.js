...
import { employeeSpecialDatesSlice, callTypes } from "./employeeSpecialDatesSlice";
...
export const fetchEmployeeSpecialDates = (queryParams) => (dispatch) => {
  ...
  return requestFromServer  
    ...
    .then((response) => {
      ...
      dispatch(
        actions.employeeSpecialDatesFetched({ totalCount: TotalCount, entities: Items })  
      );
    })  
    .catch((error) => {
...
export const fetchEmployeeSpecialDate = (id) => (dispatch) => {
  if (!id) {
    return dispatch(actions.employeeSpecialDateFetched({ employeeSpecialDateForEdit: undefined }));
  }
  ...
  return requestFromServer  
    ...
    .then((response) => {
      ...
      dispatch(actions.employeeSpecialDateFetched({ employeeSpecialDateForEdit: employeeSpecialDate }));
    })  
    .catch((error) => {
...
export const createEmployeeSpecialDate = (employeeSpecialDateForCreation) => (dispatch) => {
  dispatch(actions.startCall({ callType: callTypes.action }));
  return requestFromServer  
...
export const updateEmployeeSpecialDate = (employeeSpecialDate) => (dispatch) => {
  dispatch(actions.startCall({ callType: callTypes.action }));
  return requestFromServer  

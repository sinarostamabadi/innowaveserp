...
export function updateEmployeeSpecialDate(id, employeeSpecialDates) {
  return axios.put(
    `${EMPLOYEESPECIALDATES_URL}/put/${id}`,
...
export function updateStatusForEmployeeSpecialDates(ids, status) {
  return axios.post(
    `${EMPLOYEESPECIALDATES_URL}/updateStatusForEmployeeSpecialDates`,
    {
      ids,
      status,
    }
...
export function deleteEmployeeSpecialDate(employeeSpecialDatesId) {
  return axios.delete(
    `${EMPLOYEESPECIALDATES_URL}/delete/${employeeSpecialDatesId}`
  );
}
// DELETE EmployeeSpecialDates by ids
export function deleteEmployeeSpecialDates(ids) {
  return axios.post(
    `${EMPLOYEESPECIALDATES_URL}/deleteEmployeeSpecialDates`,
    ids
  );
}

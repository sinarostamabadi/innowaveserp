...
export function getSoldiershipExemptionById(soldiershipExemptionsId) {
  return axios.get(
    `${SOLDIERSHIPEXEMPTIONS_URL}/get/${soldiershipExemptionsId}`
  );
}
...
export function updateSoldiershipExemption(id, soldiershipExemptions) {
  return axios.put(
    `${SOLDIERSHIPEXEMPTIONS_URL}/put/${id}`,
    soldiershipExemptions
  );
}
// UPDATE Status
export function updateStatusForSoldiershipExemptions(ids, status) {
  return axios.post(
    `${SOLDIERSHIPEXEMPTIONS_URL}/updateStatusForSoldiershipExemptions`,
    {
      ids,
      status,
    }
...
export function deleteSoldiershipExemption(soldiershipExemptionsId) {
  return axios.delete(
    `${SOLDIERSHIPEXEMPTIONS_URL}/delete/${soldiershipExemptionsId}`
  );
}
// DELETE SoldiershipExemptions by ids
export function deleteSoldiershipExemptions(ids) {
  return axios.post(
    `${SOLDIERSHIPEXEMPTIONS_URL}/deleteSoldiershipExemptions`,
    ids
  );
}

...
export function updateRewardOrPenaltyType(id, rewardOrPenaltyTypes) {
  return axios.put(`${REWARDORPENALTYTYPES_URL}/put/${id}`, rewardOrPenaltyTypes);
}
// UPDATE Status  
export function updateStatusForRewardOrPenaltyTypes(ids, status) {
  return axios.post(`${REWARDORPENALTYTYPES_URL}/updateStatusForRewardOrPenaltyTypes`, {
    ids,
    status,
  });
}
...
export function deleteRewardOrPenaltyType(rewardOrPenaltyTypesId) {
  return axios.delete(`${REWARDORPENALTYTYPES_URL}/delete/${rewardOrPenaltyTypesId}`);
}
// DELETE RewardOrPenaltyTypes by ids  
export function deleteRewardOrPenaltyTypes(ids) {
return axios.post(`${REWARDORPENALTYTYPES_URL}/deleteRewardOrPenaltyTypes`, ids);
}
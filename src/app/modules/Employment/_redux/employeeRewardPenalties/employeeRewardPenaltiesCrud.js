...
export function createEmployeeRewardPenalty(employeeRewardPenalties) { 
  return axios.post(`${EMPLOYEEREWARDPENALTIES_URL}/post`, employeeRewardPenalties); 
}
// READ  
...
export function getEmployeeRewardPenaltyById(employeeRewardPenaltiesId) {
  return axios.get(`${EMPLOYEEREWARDPENALTIES_URL}/get/${employeeRewardPenaltiesId}`);
}
...
export function updateEmployeeRewardPenalty(id, employeeRewardPenalties) {
  return axios.put(`${EMPLOYEEREWARDPENALTIES_URL}/put/${id}`, employeeRewardPenalties);
}
// UPDATE Status  
export function updateStatusForEmployeeRewardPenalties(ids, status) {
  return axios.post(`${EMPLOYEEREWARDPENALTIES_URL}/updateStatusForEmployeeRewardPenalties`, {
    ids,
    status,
  });
}
...
export function deleteEmployeeRewardPenalty(employeeRewardPenaltiesId) {
  return axios.delete(`${EMPLOYEEREWARDPENALTIES_URL}/delete/${employeeRewardPenaltiesId}`);
}
// DELETE EmployeeRewardPenalties by ids  
export function deleteEmployeeRewardPenalties(ids) {
return axios.post(`${EMPLOYEEREWARDPENALTIES_URL}/deleteEmployeeRewardPenalties`, ids);
}
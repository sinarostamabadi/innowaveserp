...
export const fetchWorkShiftCalenders = (queryParams) => (dispatch) => {
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.workShiftCalendersFetched({
...
export const fetchWorkShiftCalender = (id) => (dispatch) => {
  if (!id) {
    return dispatch(
      actions.workShiftCalenderFetched({ workShiftCalenderForEdit: undefined })
    );
  }
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.workShiftCalenderFetched({
          workShiftCalenderForEdit: workShiftCalender,
        })
      );
    })
    .catch((error) => {
...
export const createWorkShiftCalender =
  (workShiftCalenderForCreation) => (dispatch) => {
    dispatch(actions.startCall({ callType: callTypes.action }));
    return requestFromServer

...
export const fetchEmployeeChilds = (queryParams) => (dispatch) => {
  ...
  return requestFromServer  
    ...
    .then((response) => {
      ...
      dispatch(
        actions.employeeChildsFetched({ totalCount: TotalCount, entities: Items })  
      );
    })  
    .catch((error) => {
...
export const fetchEmployeeChild = (id) => (dispatch) => {
  if (!id) {
    return dispatch(actions.employeeChildFetched({ employeeChildForEdit: undefined }));
  }
  ...
  return requestFromServer  
    ...
    .then((response) => {
      ...
      dispatch(actions.employeeChildFetched({ employeeChildForEdit: employeeChild }));
    })  
    .catch((error) => {

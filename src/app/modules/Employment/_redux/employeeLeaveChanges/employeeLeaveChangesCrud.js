...
export function updateEmployeeLeaveChange(id, employeeLeaveChanges) {
  return axios.put(`${EMPLOYEELEAVECHANGES_URL}/put/${id}`, employeeLeaveChanges);
}
// UPDATE Status  
export function updateStatusForEmployeeLeaveChanges(ids, status) {
  return axios.post(`${EMPLOYEELEAVECHANGES_URL}/updateStatusForEmployeeLeaveChanges`, {
    ids,
    status,
  });
}
...
export function deleteEmployeeLeaveChange(employeeLeaveChangesId) {
  return axios.delete(`${EMPLOYEELEAVECHANGES_URL}/delete/${employeeLeaveChangesId}`);
}
// DELETE EmployeeLeaveChanges by ids  
export function deleteEmployeeLeaveChanges(ids) {
return axios.post(`${EMPLOYEELEAVECHANGES_URL}/deleteEmployeeLeaveChanges`, ids);
}
...
export const fetchIOTransactions = (queryParams) => (dispatch) => {
  ...
  return requestFromServer  
    ...
    .then((response) => {
      ...
      dispatch(
        actions.iOTransactionsFetched({ totalCount: TotalCount, entities: Items })  
      );
    })  
    .catch((error) => {
...
export const fetchIOTransaction = (id) => (dispatch) => {
  if (!id) {
    return dispatch(actions.iOTransactionFetched({ iOTransactionForEdit: undefined }));
  }
  ...
  return requestFromServer  
    ...
    .then((response) => {
      ...
      dispatch(actions.iOTransactionFetched({ iOTransactionForEdit: iOTransaction }));
    })  
    .catch((error) => {

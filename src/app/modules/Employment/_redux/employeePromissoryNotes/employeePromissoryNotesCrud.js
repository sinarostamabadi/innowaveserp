...
export function createEmployeePromissoryNote(employeePromissoryNotes) {
  return axios.post(
    `${EMPLOYEEPROMISSORYNOTES_URL}/post`,
    employeePromissoryNotes
  );
}
// READ
...
export function getEmployeePromissoryNoteById(employeePromissoryNotesId) {
  return axios.get(
    `${EMPLOYEEPROMISSORYNOTES_URL}/get/${employeePromissoryNotesId}`
  );
}
...
export function updateEmployeePromissoryNote(id, employeePromissoryNotes) {
  return axios.put(
    `${EMPLOYEEPROMISSORYNOTES_URL}/put/${id}`,
    employeePromissoryNotes
  );
}
// UPDATE Status
export function updateStatusForEmployeePromissoryNotes(ids, status) {
  return axios.post(
    `${EMPLOYEEPROMISSORYNOTES_URL}/updateStatusForEmployeePromissoryNotes`,
    {
      ids,
      status,
    }
...
export function deleteEmployeePromissoryNote(employeePromissoryNotesId) {
  return axios.delete(
    `${EMPLOYEEPROMISSORYNOTES_URL}/delete/${employeePromissoryNotesId}`
  );
}
// DELETE EmployeePromissoryNotes by ids
export function deleteEmployeePromissoryNotes(ids) {
  return axios.post(
    `${EMPLOYEEPROMISSORYNOTES_URL}/deleteEmployeePromissoryNotes`,
    ids
  );
}

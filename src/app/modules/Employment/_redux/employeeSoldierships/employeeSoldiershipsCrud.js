...
export function updateEmployeeSoldiership(id, employeeSoldierships) {
  return axios.put(`${EMPLOYEESOLDIERSHIPS_URL}/put/${id}`, employeeSoldierships);
}
// UPDATE Status  
export function updateStatusForEmployeeSoldierships(ids, status) {
  return axios.post(`${EMPLOYEESOLDIERSHIPS_URL}/updateStatusForEmployeeSoldierships`, {
    ids,
    status,
  });
}
...
export function deleteEmployeeSoldiership(employeeSoldiershipsId) {
  return axios.delete(`${EMPLOYEESOLDIERSHIPS_URL}/delete/${employeeSoldiershipsId}`);
}
// DELETE EmployeeSoldierships by ids  
export function deleteEmployeeSoldierships(ids) {
return axios.post(`${EMPLOYEESOLDIERSHIPS_URL}/deleteEmployeeSoldierships`, ids);
}
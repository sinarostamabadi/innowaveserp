...
export function createEmployeePhysicalCondition(employeePhysicalConditions) {
  return axios.post(
    `${EMPLOYEEPHYSICALCONDITIONS_URL}/post`,
    employeePhysicalConditions
  );
}
// READ
...
export function getEmployeePhysicalConditionById(employeePhysicalConditionsId) {
  return axios.get(
    `${EMPLOYEEPHYSICALCONDITIONS_URL}/get/${employeePhysicalConditionsId}`
  );
}
...
export function updateEmployeePhysicalCondition(
  id,
  employeePhysicalConditions
) {
  return axios.put(
    `${EMPLOYEEPHYSICALCONDITIONS_URL}/put/${id}`,
    employeePhysicalConditions
  );
}
// UPDATE Status
export function updateStatusForEmployeePhysicalConditions(ids, status) {
  return axios.post(
    `${EMPLOYEEPHYSICALCONDITIONS_URL}/updateStatusForEmployeePhysicalConditions`,
    {
      ids,
      status,
    }
...
export function deleteEmployeePhysicalCondition(employeePhysicalConditionsId) {
  return axios.delete(
    `${EMPLOYEEPHYSICALCONDITIONS_URL}/delete/${employeePhysicalConditionsId}`
  );
}
// DELETE EmployeePhysicalConditions by ids
export function deleteEmployeePhysicalConditions(ids) {
  return axios.post(
    `${EMPLOYEEPHYSICALCONDITIONS_URL}/deleteEmployeePhysicalConditions`,
    ids
  );
}

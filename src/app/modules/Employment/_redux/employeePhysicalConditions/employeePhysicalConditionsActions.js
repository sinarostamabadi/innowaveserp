...
import {
  employeePhysicalConditionsSlice,
  callTypes,
} from "./employeePhysicalConditionsSlice";
...
export const fetchEmployeePhysicalConditions = (queryParams) => (dispatch) => {
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.employeePhysicalConditionsFetched({
...
export const fetchEmployeePhysicalCondition = (id) => (dispatch) => {
  if (!id) {
    return dispatch(
      actions.employeePhysicalConditionFetched({
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.employeePhysicalConditionFetched({
          employeePhysicalConditionForEdit: employeePhysicalCondition,
        })
      );
    })
    .catch((error) => {
...
export const createEmployeePhysicalCondition =
  (employeePhysicalConditionForCreation) => (dispatch) => {
    dispatch(actions.startCall({ callType: callTypes.action }));
    return requestFromServer
      ...
      .then((response) => {
        const employeePhysicalCondition = response.data;
        dispatch(
          actions.employeePhysicalConditionCreated(employeePhysicalCondition)
        );
      })
      .catch((error) => {
...
export const updateEmployeePhysicalCondition =
  (employeePhysicalCondition) => (dispatch) => {
    dispatch(actions.startCall({ callType: callTypes.action }));
    return requestFromServer
      .updateEmployeePhysicalCondition(employeePhysicalCondition)
      .then((response) => {
        dispatch(
          actions.employeePhysicalConditionUpdated({
...
export const updateEmployeePhysicalConditionsStatus =
  (ids, status) => (dispatch) => {
    dispatch(actions.startCall({ callType: callTypes.action }));
    return requestFromServer
      ...
      .then(() => {
        dispatch(
          actions.employeePhysicalConditionsStatusUpdated({ ids, status })
        );
      })
      .catch((error) => {

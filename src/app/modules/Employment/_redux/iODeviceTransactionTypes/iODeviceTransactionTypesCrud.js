...
export function createIODeviceTransactionType(iODeviceTransactionTypes) {
  return axios.post(
    `${IODEVICETRANSACTIONTYPES_URL}/post`,
    iODeviceTransactionTypes
  );
}
// READ
...
export function getIODeviceTransactionTypeById(iODeviceTransactionTypesId) {
  return axios.get(
    `${IODEVICETRANSACTIONTYPES_URL}/get/${iODeviceTransactionTypesId}`
  );
}
...
export function updateIODeviceTransactionType(id, iODeviceTransactionTypes) {
  return axios.put(
    `${IODEVICETRANSACTIONTYPES_URL}/put/${id}`,
    iODeviceTransactionTypes
  );
}
// UPDATE Status
export function updateStatusForIODeviceTransactionTypes(ids, status) {
  return axios.post(
    `${IODEVICETRANSACTIONTYPES_URL}/updateStatusForIODeviceTransactionTypes`,
    {
      ids,
      status,
    }
...
export function deleteIODeviceTransactionType(iODeviceTransactionTypesId) {
  return axios.delete(
    `${IODEVICETRANSACTIONTYPES_URL}/delete/${iODeviceTransactionTypesId}`
  );
}
// DELETE IODeviceTransactionTypes by ids
export function deleteIODeviceTransactionTypes(ids) {
  return axios.post(
    `${IODEVICETRANSACTIONTYPES_URL}/deleteIODeviceTransactionTypes`,
    ids
  );
}

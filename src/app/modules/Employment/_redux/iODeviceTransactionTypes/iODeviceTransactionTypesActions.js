...
import {
  iODeviceTransactionTypesSlice,
  callTypes,
} from "./iODeviceTransactionTypesSlice";
...
export const fetchIODeviceTransactionTypes = (queryParams) => (dispatch) => {
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.iODeviceTransactionTypesFetched({
...
export const fetchIODeviceTransactionType = (id) => (dispatch) => {
  if (!id) {
    return dispatch(
      actions.iODeviceTransactionTypeFetched({
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.iODeviceTransactionTypeFetched({
          iODeviceTransactionTypeForEdit: iODeviceTransactionType,
        })
      );
    })
    .catch((error) => {
...
export const createIODeviceTransactionType =
  (iODeviceTransactionTypeForCreation) => (dispatch) => {
    dispatch(actions.startCall({ callType: callTypes.action }));
    return requestFromServer
      ...
      .then((response) => {
        const iODeviceTransactionType = response.data;
        dispatch(
          actions.iODeviceTransactionTypeCreated(iODeviceTransactionType)
        );
      })
      .catch((error) => {
...
export const updateIODeviceTransactionType =
  (iODeviceTransactionType) => (dispatch) => {
    dispatch(actions.startCall({ callType: callTypes.action }));
    return requestFromServer
      .updateIODeviceTransactionType(iODeviceTransactionType)
      .then((response) => {
        dispatch(
          actions.iODeviceTransactionTypeUpdated({ iODeviceTransactionType })
        );
      })
      .catch((error) => {
...
export const updateIODeviceTransactionTypesStatus =
  (ids, status) => (dispatch) => {
    dispatch(actions.startCall({ callType: callTypes.action }));
    return requestFromServer
      ...
      .then(() => {
        dispatch(
          actions.iODeviceTransactionTypesStatusUpdated({ ids, status })
        );
      })
      .catch((error) => {

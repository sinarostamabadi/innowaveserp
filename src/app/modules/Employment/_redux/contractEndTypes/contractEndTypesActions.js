...
export const fetchContractEndTypes = (queryParams) => (dispatch) => {
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.contractEndTypesFetched({
...
export const fetchContractEndType = (id) => (dispatch) => {
  if (!id) {
    return dispatch(
      actions.contractEndTypeFetched({ contractEndTypeForEdit: undefined })
    );
  }
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.contractEndTypeFetched({
          contractEndTypeForEdit: contractEndType,
        })
      );
    })
    .catch((error) => {
...
export const createContractEndType =
  (contractEndTypeForCreation) => (dispatch) => {
    dispatch(actions.startCall({ callType: callTypes.action }));
    return requestFromServer

...
import {
  organizationChartEmployeesSlice,
  callTypes,
} from "./organizationChartEmployeesSlice";
...
export const fetchOrganizationChartEmployees = (queryParams) => (dispatch) => {
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.organizationChartEmployeesFetched({
...
export const fetchOrganizationChartEmployee = (id) => (dispatch) => {
  if (!id) {
    return dispatch(
      actions.organizationChartEmployeeFetched({
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.organizationChartEmployeeFetched({
          organizationChartEmployeeForEdit: organizationChartEmployee,
        })
      );
    })
    .catch((error) => {
...
export const createOrganizationChartEmployee =
  (organizationChartEmployeeForCreation) => (dispatch) => {
    dispatch(actions.startCall({ callType: callTypes.action }));
    return requestFromServer
      ...
      .then((response) => {
        const organizationChartEmployee = response.data;
        dispatch(
          actions.organizationChartEmployeeCreated(organizationChartEmployee)
        );
      })
      .catch((error) => {
...
export const updateOrganizationChartEmployee =
  (organizationChartEmployee) => (dispatch) => {
    dispatch(actions.startCall({ callType: callTypes.action }));
    return requestFromServer
      .updateOrganizationChartEmployee(organizationChartEmployee)
      .then((response) => {
        dispatch(
          actions.organizationChartEmployeeUpdated({
...
export const updateOrganizationChartEmployeesStatus =
  (ids, status) => (dispatch) => {
    dispatch(actions.startCall({ callType: callTypes.action }));
    return requestFromServer
      ...
      .then(() => {
        dispatch(
          actions.organizationChartEmployeesStatusUpdated({ ids, status })
        );
      })
      .catch((error) => {

...
export function createOrganizationChartEmployee(organizationChartEmployees) { 
  return axios.post(`${ORGANIZATIONCHARTEMPLOYEES_URL}/post`, organizationChartEmployees); 
}
// READ  
...
export function getOrganizationChartEmployeeById(organizationChartEmployeesId) {
  return axios.get(`${ORGANIZATIONCHARTEMPLOYEES_URL}/get/${organizationChartEmployeesId}`);
}
...
export function updateOrganizationChartEmployee(id, organizationChartEmployees) {
  return axios.put(`${ORGANIZATIONCHARTEMPLOYEES_URL}/put/${id}`, organizationChartEmployees);
}
// UPDATE Status  
export function updateStatusForOrganizationChartEmployees(ids, status) {
  return axios.post(`${ORGANIZATIONCHARTEMPLOYEES_URL}/updateStatusForOrganizationChartEmployees`, {
    ids,
    status,
  });
}
...
export function deleteOrganizationChartEmployee(organizationChartEmployeesId) {
  return axios.delete(`${ORGANIZATIONCHARTEMPLOYEES_URL}/delete/${organizationChartEmployeesId}`);
}
// DELETE OrganizationChartEmployees by ids  
export function deleteOrganizationChartEmployees(ids) {
return axios.post(`${ORGANIZATIONCHARTEMPLOYEES_URL}/deleteOrganizationChartEmployees`, ids);
}
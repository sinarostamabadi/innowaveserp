...
export const fetchEmployeeContracts = (queryParams) => (dispatch) => {
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.employeeContractsFetched({
...
export const fetchEmployeeContract = (id) => (dispatch) => {
  if (!id) {
    return dispatch(
      actions.employeeContractFetched({ employeeContractForEdit: undefined })
    );
  }
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.employeeContractFetched({
          employeeContractForEdit: employeeContract,
        })
      );
    })
    .catch((error) => {
...
export const createEmployeeContract =
  (employeeContractForCreation) => (dispatch) => {
    dispatch(actions.startCall({ callType: callTypes.action }));
    return requestFromServer

...
export function createPhysicalConditionType(physicalConditionTypes) { 
  return axios.post(`${PHYSICALCONDITIONTYPES_URL}/post`, physicalConditionTypes); 
}
// READ  
...
export function getPhysicalConditionTypeById(physicalConditionTypesId) {
  return axios.get(`${PHYSICALCONDITIONTYPES_URL}/get/${physicalConditionTypesId}`);
}
...
export function updatePhysicalConditionType(id, physicalConditionTypes) {
  return axios.put(`${PHYSICALCONDITIONTYPES_URL}/put/${id}`, physicalConditionTypes);
}
// UPDATE Status  
export function updateStatusForPhysicalConditionTypes(ids, status) {
  return axios.post(`${PHYSICALCONDITIONTYPES_URL}/updateStatusForPhysicalConditionTypes`, {
    ids,
    status,
  });
}
...
export function deletePhysicalConditionType(physicalConditionTypesId) {
  return axios.delete(`${PHYSICALCONDITIONTYPES_URL}/delete/${physicalConditionTypesId}`);
}
// DELETE PhysicalConditionTypes by ids  
export function deletePhysicalConditionTypes(ids) {
return axios.post(`${PHYSICALCONDITIONTYPES_URL}/deletePhysicalConditionTypes`, ids);
}
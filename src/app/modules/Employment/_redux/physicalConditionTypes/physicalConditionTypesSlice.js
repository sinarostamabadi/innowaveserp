...
export const physicalConditionTypesSlice = createSlice({
  name: "physicalConditionTypes",
  initialState: initialPhysicalConditionTypesState,
  reducers: {
    ...
    physicalConditionTypesStatusUpdated: (state, action) => {
      ...
      state.entities = state.entities.map((entity) => {
        if (ids.findIndex((id) => id === entity.PhysicalConditionTypeId) > -1) {

...
import {
  employeeMonthlyCalculatedsSlice,
  callTypes,
} from "./employeeMonthlyCalculatedsSlice";
...
export const fetchEmployeeMonthlyCalculateds = (queryParams) => (dispatch) => {
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.employeeMonthlyCalculatedsFetched({
...
export const fetchEmployeeMonthlyCalculated = (id) => (dispatch) => {
  if (!id) {
    return dispatch(
      actions.employeeMonthlyCalculatedFetched({
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.employeeMonthlyCalculatedFetched({
          employeeMonthlyCalculatedForEdit: employeeMonthlyCalculated,
        })
      );
    })
    .catch((error) => {
...
export const createEmployeeMonthlyCalculated =
  (employeeMonthlyCalculatedForCreation) => (dispatch) => {
    dispatch(actions.startCall({ callType: callTypes.action }));
    return requestFromServer
      ...
      .then((response) => {
        const employeeMonthlyCalculated = response.data;
        dispatch(
          actions.employeeMonthlyCalculatedCreated(employeeMonthlyCalculated)
        );
      })
      .catch((error) => {
...
export const updateEmployeeMonthlyCalculated =
  (employeeMonthlyCalculated) => (dispatch) => {
    dispatch(actions.startCall({ callType: callTypes.action }));
    return requestFromServer
      .updateEmployeeMonthlyCalculated(employeeMonthlyCalculated)
      .then((response) => {
        dispatch(
          actions.employeeMonthlyCalculatedUpdated({
...
export const updateEmployeeMonthlyCalculatedsStatus =
  (ids, status) => (dispatch) => {
    dispatch(actions.startCall({ callType: callTypes.action }));
    return requestFromServer
      ...
      .then(() => {
        dispatch(
          actions.employeeMonthlyCalculatedsStatusUpdated({ ids, status })
        );
      })
      .catch((error) => {

...
export function createOrganizationChartLevel(organizationChartLevels) { 
  return axios.post(`${ORGANIZATIONCHARTLEVELS_URL}/post`, organizationChartLevels); 
}
// READ  
...
export function getOrganizationChartLevelById(organizationChartLevelsId) {
  return axios.get(`${ORGANIZATIONCHARTLEVELS_URL}/get/${organizationChartLevelsId}`);
}
...
export function updateOrganizationChartLevel(id, organizationChartLevels) {
  return axios.put(`${ORGANIZATIONCHARTLEVELS_URL}/put/${id}`, organizationChartLevels);
}
// UPDATE Status  
export function updateStatusForOrganizationChartLevels(ids, status) {
  return axios.post(`${ORGANIZATIONCHARTLEVELS_URL}/updateStatusForOrganizationChartLevels`, {
    ids,
    status,
  });
}
...
export function deleteOrganizationChartLevel(organizationChartLevelsId) {
  return axios.delete(`${ORGANIZATIONCHARTLEVELS_URL}/delete/${organizationChartLevelsId}`);
}
// DELETE OrganizationChartLevels by ids  
export function deleteOrganizationChartLevels(ids) {
return axios.post(`${ORGANIZATIONCHARTLEVELS_URL}/deleteOrganizationChartLevels`, ids);
}
...
} from "./IODeviceTransactionTypesUIContext";
...
export function IODeviceTransactionTypesCard() {
  ...
  const iODeviceTransactionTypesUIProps = useMemo(() => {
    return {
      ...
      newIODeviceTransactionTypeButtonClick:
        iODeviceTransactionTypesUIContext.newIODeviceTransactionTypeButtonClick,
      openDeleteIODeviceTransactionTypesDialog:
        iODeviceTransactionTypesUIContext.openDeleteIODeviceTransactionTypesDialog,
      ...
      openUpdateIODeviceTransactionTypesStatusDialog:
        iODeviceTransactionTypesUIContext.openUpdateIODeviceTransactionTypesStatusDialog,
      openFetchIODeviceTransactionTypesDialog:
        iODeviceTransactionTypesUIContext.openFetchIODeviceTransactionTypesDialog,
    };
  ...
  return (
    <Card>
      <CardHeader
        title={t("Common.List") + " " + t("IODeviceTransactionType.Entity")}
      >
        <CardHeaderToolbar>
          <button
            type="button"
            ...
            onClick={
              iODeviceTransactionTypesUIProps.newIODeviceTransactionTypeButtonClick
            }
          >

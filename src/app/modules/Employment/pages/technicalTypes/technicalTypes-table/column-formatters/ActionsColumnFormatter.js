...
export const ActionsColumnFormatter = (
  ...
  <>
    <OverlayTrigger overlay={<Tooltip id="technicalTypes-edit-tooltip">{t("Common.Edit")}</Tooltip>}>
      <a
    ...
    <> </>
    <OverlayTrigger
      overlay={<Tooltip id="technicalTypes-delete-tooltip">{t("Common.Delete")}</Tooltip>}
    >
      <a

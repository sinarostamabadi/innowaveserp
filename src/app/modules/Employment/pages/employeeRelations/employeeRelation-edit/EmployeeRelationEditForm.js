  ...
  return (
    <>
      <Formik
        ...
        initialValues={employeeRelation}
        validationSchema={EmployeeRelationEditSchema}
        onSubmit={(values) => {
          saveEmployeeRelation(values);
        }}
      >
        {({ handleSubmit }) => (
          <>
              ...
              <div className="form-group row">
                <div className="col-lg-6">
                  <Field
                    ...
                    component={Input}
                    customFeedbackLabel=""
                    label={t("EmployeeRelation.TitleFa")}
                  />
                </div>
                <div className="col-lg-6">
                  <Field
                    ...
                    component={Input}
                    customFeedbackLabel=""
                    label={t("EmployeeRelation.TitleEn")}
                  />
                </div>
              </div>
              <button

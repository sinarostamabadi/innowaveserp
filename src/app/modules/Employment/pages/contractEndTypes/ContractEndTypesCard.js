...
import {
  useContractEndTypesUIContext,
  ContractEndTypesUIConsumer,
} from "./ContractEndTypesUIContext";
  ...
  const contractEndTypesUIProps = useMemo(() => {
    return {
      ...
      newContractEndTypeButtonClick:
        contractEndTypesUIContext.newContractEndTypeButtonClick,
      openDeleteContractEndTypesDialog:
        contractEndTypesUIContext.openDeleteContractEndTypesDialog,
      openEditContractEndTypePage:
        contractEndTypesUIContext.openEditContractEndTypePage,
      openUpdateContractEndTypesStatusDialog:
        contractEndTypesUIContext.openUpdateContractEndTypesStatusDialog,
      openFetchContractEndTypesDialog:
        contractEndTypesUIContext.openFetchContractEndTypesDialog,
    };

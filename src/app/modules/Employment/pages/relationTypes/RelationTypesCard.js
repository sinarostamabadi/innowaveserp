...
import {
  useRelationTypesUIContext,
  RelationTypesUIConsumer,
} from "./RelationTypesUIContext";
  ...
  const relationTypesUIProps = useMemo(() => {
    return {
      ...
      newRelationTypeButtonClick:
        relationTypesUIContext.newRelationTypeButtonClick,
      openDeleteRelationTypesDialog:
        relationTypesUIContext.openDeleteRelationTypesDialog,
      openEditRelationTypePage: relationTypesUIContext.openEditRelationTypePage,
      openUpdateRelationTypesStatusDialog:
        relationTypesUIContext.openUpdateRelationTypesStatusDialog,
      openFetchRelationTypesDialog:
        relationTypesUIContext.openFetchRelationTypesDialog,
    };

...
import { useEmployeeLeavesUIContext, EmployeeLeavesUIConsumer } from "./EmployeeLeavesUIContext";
...
export function EmployeeLeavesCard() {
  ...
  const employeeLeavesUIProps = useMemo(() => {
    return {
      ...
      newEmployeeLeaveButtonClick: employeeLeavesUIContext.newEmployeeLeaveButtonClick,
      openDeleteEmployeeLeavesDialog: employeeLeavesUIContext.openDeleteEmployeeLeavesDialog,
      openEditEmployeeLeavePage: employeeLeavesUIContext.openEditEmployeeLeavePage,
      openUpdateEmployeeLeavesStatusDialog: employeeLeavesUIContext.openUpdateEmployeeLeavesStatusDialog,
      openFetchEmployeeLeavesDialog: employeeLeavesUIContext.openFetchEmployeeLeavesDialog,
    };

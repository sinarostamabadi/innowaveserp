...
import {
  usePhysicalConditionTypesUIContext,
  PhysicalConditionTypesUIConsumer,
} from "./PhysicalConditionTypesUIContext";
...
export function PhysicalConditionTypesCard() {
  ...
  const physicalConditionTypesUIProps = useMemo(() => {
    return {
      ...
      newPhysicalConditionTypeButtonClick:
        physicalConditionTypesUIContext.newPhysicalConditionTypeButtonClick,
      openDeletePhysicalConditionTypesDialog:
        physicalConditionTypesUIContext.openDeletePhysicalConditionTypesDialog,
      ...
      openUpdatePhysicalConditionTypesStatusDialog:
        physicalConditionTypesUIContext.openUpdatePhysicalConditionTypesStatusDialog,
      openFetchPhysicalConditionTypesDialog:
        physicalConditionTypesUIContext.openFetchPhysicalConditionTypesDialog,
    };
  ...
  return (
    <Card>
      <CardHeader
        title={t("Common.List") + " " + t("PhysicalConditionType.Entity")}
      >
        <CardHeaderToolbar>
          <button
            type="button"
            ...
            onClick={
              physicalConditionTypesUIProps.newPhysicalConditionTypeButtonClick
            }
          >

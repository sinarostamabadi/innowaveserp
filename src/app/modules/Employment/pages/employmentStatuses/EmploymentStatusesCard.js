...
import { useEmploymentStatusesUIContext, EmploymentStatusesUIConsumer } from "./EmploymentStatusesUIContext";
...
export function EmploymentStatusesCard() {
  ...
  const employmentStatusesUIProps = useMemo(() => {
    return {
      ...
      newEmploymentStatusButtonClick: employmentStatusesUIContext.newEmploymentStatusButtonClick,
      openDeleteEmploymentStatusesDialog: employmentStatusesUIContext.openDeleteEmploymentStatusesDialog,
      openEditEmploymentStatusPage: employmentStatusesUIContext.openEditEmploymentStatusPage,
      openUpdateEmploymentStatusesStatusDialog: employmentStatusesUIContext.openUpdateEmploymentStatusesStatusDialog,
      openFetchEmploymentStatusesDialog: employmentStatusesUIContext.openFetchEmploymentStatusesDialog,
    };

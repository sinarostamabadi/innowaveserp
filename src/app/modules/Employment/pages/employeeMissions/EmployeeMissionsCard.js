...
import {
  useEmployeeMissionsUIContext,
  EmployeeMissionsUIConsumer,
} from "./EmployeeMissionsUIContext";
  ...
  const employeeMissionsUIProps = useMemo(() => {
    return {
      ...
      newEmployeeMissionButtonClick:
        employeeMissionsUIContext.newEmployeeMissionButtonClick,
      openDeleteEmployeeMissionsDialog:
        employeeMissionsUIContext.openDeleteEmployeeMissionsDialog,
      openEditEmployeeMissionPage:
        employeeMissionsUIContext.openEditEmployeeMissionPage,
      openUpdateEmployeeMissionsStatusDialog:
        employeeMissionsUIContext.openUpdateEmployeeMissionsStatusDialog,
      openFetchEmployeeMissionsDialog:
        employeeMissionsUIContext.openFetchEmployeeMissionsDialog,
    };

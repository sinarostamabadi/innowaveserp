...
} from "./EmployeePhysicalConditionsUIContext";
...
export function EmployeePhysicalConditionsCard() {
  ...
  const employeePhysicalConditionsUIProps = useMemo(() => {
    return {
      ...
      newEmployeePhysicalConditionButtonClick:
        employeePhysicalConditionsUIContext.newEmployeePhysicalConditionButtonClick,
      openDeleteEmployeePhysicalConditionsDialog:
        employeePhysicalConditionsUIContext.openDeleteEmployeePhysicalConditionsDialog,
      ...
      openUpdateEmployeePhysicalConditionsStatusDialog:
        employeePhysicalConditionsUIContext.openUpdateEmployeePhysicalConditionsStatusDialog,
      openFetchEmployeePhysicalConditionsDialog:
        employeePhysicalConditionsUIContext.openFetchEmployeePhysicalConditionsDialog,
    };
  ...
  return (
    <Card>
      <CardHeader
        title={t("Common.List") + " " + t("EmployeePhysicalCondition.Entity")}
      >
        <CardHeaderToolbar>
          <button
            type="button"
            ...
            onClick={
              employeePhysicalConditionsUIProps.newEmployeePhysicalConditionButtonClick
            }
          >

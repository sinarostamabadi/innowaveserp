...
import {
  useIOTransactionTypesUIContext,
  IOTransactionTypesUIConsumer,
} from "./IOTransactionTypesUIContext";
...
export function IOTransactionTypesCard() {
  ...
  const iOTransactionTypesUIProps = useMemo(() => {
    return {
      ...
      newIOTransactionTypeButtonClick:
        iOTransactionTypesUIContext.newIOTransactionTypeButtonClick,
      openDeleteIOTransactionTypesDialog:
        iOTransactionTypesUIContext.openDeleteIOTransactionTypesDialog,
      ...
      openUpdateIOTransactionTypesStatusDialog:
        iOTransactionTypesUIContext.openUpdateIOTransactionTypesStatusDialog,
      openFetchIOTransactionTypesDialog:
        iOTransactionTypesUIContext.openFetchIOTransactionTypesDialog,
    };
  ...
  return (
    <Card>
      <CardHeader
        title={t("Common.List") + " " + t("IOTransactionType.Entity")}
      >
        <CardHeaderToolbar>
          <button
            type="button"

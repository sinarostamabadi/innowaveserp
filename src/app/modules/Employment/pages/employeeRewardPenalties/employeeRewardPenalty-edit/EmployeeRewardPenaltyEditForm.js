  ...
  return (
    <>
      <Formik
        ...
        initialValues={employeeRewardPenalty}
        validationSchema={EmployeeRewardPenaltyEditSchema}
        onSubmit={(values) => {
          saveEmployeeRewardPenalty(values);
        }}
      >
        {({ handleSubmit }) => (
          <>
              ...
              <div className="form-group row">
                <div className="col-lg-6">
                  <Field
                    ...
                    component={Input}
                    customFeedbackLabel=""
                    label={t("EmployeeRewardPenalty.TitleFa")}
                  />
                </div>
                <div className="col-lg-6">
                  <Field
                    ...
                    component={Input}
                    customFeedbackLabel=""
                    label={t("EmployeeRewardPenalty.TitleEn")}
                  />
                </div>
              </div>
              <button

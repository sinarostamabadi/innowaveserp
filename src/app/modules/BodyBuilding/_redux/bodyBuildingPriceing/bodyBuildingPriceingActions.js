...
import { bodyBuildingPriceingSlice, callTypes } from "./bodyBuildingPriceingSlice";
...
export const fetchBodyBuildingPriceings = (queryParams) => (dispatch) => {
  ...
  return requestFromServer  
    ...
    .then((response) => {
      ...
      dispatch(
        actions.bodyBuildingPriceingFetched({ totalCount: TotalCount, entities: Items })  
      );
    })  
    .catch((error) => {
...
export const fetchBodyBuildingPriceing = (id) => (dispatch) => {
  if (!id) {
    return dispatch(actions.bodyBuildingPriceingFetched({ bodyBuildingPriceingForEdit: undefined }));
  }
  ...
  return requestFromServer  
    ...
    .then((response) => {
      ...
      dispatch(actions.bodyBuildingPriceingFetched({ bodyBuildingPriceingForEdit: bodyBuildingPriceing }));
    })  
    .catch((error) => {
      error.clientMessage = "Can't find bodyBuildingPriceing";
...
export const createBodyBuildingPriceing = (bodyBuildingPriceingForCreation) => (dispatch) => {
  dispatch(actions.startCall({ callType: callTypes.action }));
  return requestFromServer  
...
export const updateBodyBuildingPriceing = (bodyBuildingPriceing) => (dispatch) => {
  dispatch(actions.startCall({ callType: callTypes.action }));
  return requestFromServer  

...
import { bodyBuildingReserveUsedDatesSlice, callTypes } from "./bodyBuildingReserveUsedDatesSlice";
const { actions } = bodyBuildingReserveUsedDatesSlice;
export const fetchBodyBuildingReserveUsedDates = (queryParams) => (dispatch) => {
  ...
  return requestFromServer  
    ...
    .then((response) => {
      ...
      dispatch(
        actions.bodyBuildingReserveUsedDatesFetched({ totalCount: TotalCount, entities: Items })  
      );
    })  
    .catch((error) => {
...
export const fetchBodyBuildingReserveUsedDate = (id) => (dispatch) => {
  if (!id) {
    return dispatch(actions.bodyBuildingReserveUsedDateFetched({ bodyBuildingReserveUsedDateForEdit: undefined }));
  }
  ...
  return requestFromServer  
    ...
    .then((response) => {
      ...
      dispatch(actions.bodyBuildingReserveUsedDateFetched({ bodyBuildingReserveUsedDateForEdit: bodyBuildingReserveUsedDate }));
    })  
    .catch((error) => {
...
export const createBodyBuildingReserveUsedDate = (bodyBuildingReserveUsedDateForCreation) => (dispatch) => {
  dispatch(actions.startCall({ callType: callTypes.action }));
  return requestFromServer  
    .createBodyBuildingReserveUsedDate(bodyBuildingReserveUsedDateForCreation)  
    .then((response) => {
      const bodyBuildingReserveUsedDate = response.data;
      dispatch(actions.bodyBuildingReserveUsedDateCreated(bodyBuildingReserveUsedDate));
    })  
    .catch((error) => {
...
export const updateBodyBuildingReserveUsedDate = (bodyBuildingReserveUsedDate) => (dispatch) => {
  dispatch(actions.startCall({ callType: callTypes.action }));
  return requestFromServer  
    .updateBodyBuildingReserveUsedDate(bodyBuildingReserveUsedDate)  
    .then((response) => {
      dispatch(actions.bodyBuildingReserveUsedDateUpdated({ bodyBuildingReserveUsedDate }));
    })  
    .catch((error) => {
...
export const updateBodyBuildingReserveUsedDatesStatus = (ids, status) => (dispatch) => {
  dispatch(actions.startCall({ callType: callTypes.action }));
  return requestFromServer  
    .updateStatusForBodyBuildingReserveUsedDates(ids, status)  
    .then(() => {
      dispatch(actions.bodyBuildingReserveUsedDatesStatusUpdated({ ids, status }));
    })  
    .catch((error) => {
      error.clientMessage = "Can't update bodyBuildingReserveUsedDates status";
      dispatch(actions.catchError({ error, callType: callTypes.action }));
    });
};

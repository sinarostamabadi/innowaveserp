...
import { bodyBuildingAccountTypesSlice, callTypes } from "./bodyBuildingAccountTypesSlice";
...
export const fetchBodyBuildingAccountTypes = (queryParams) => (dispatch) => {
  ...
  return requestFromServer  
    ...
    .then((response) => {
      ...
      dispatch(
        actions.bodyBuildingAccountTypesFetched({ totalCount: TotalCount, entities: Items })  
      );
    })  
    .catch((error) => {
...
export const fetchBodyBuildingAccountType = (id) => (dispatch) => {
  if (!id) {
    return dispatch(actions.bodyBuildingAccountTypeFetched({ bodyBuildingAccountTypeForEdit: undefined }));
  }
  ...
  return requestFromServer  
    ...
    .then((response) => {
      ...
      dispatch(actions.bodyBuildingAccountTypeFetched({ bodyBuildingAccountTypeForEdit: bodyBuildingAccountType }));
    })  
    .catch((error) => {
...
export const createBodyBuildingAccountType = (bodyBuildingAccountTypeForCreation) => (dispatch) => {
  dispatch(actions.startCall({ callType: callTypes.action }));
  return requestFromServer  
    .createBodyBuildingAccountType(bodyBuildingAccountTypeForCreation)  
    .then((response) => {
      const bodyBuildingAccountType = response.data;
      dispatch(actions.bodyBuildingAccountTypeCreated(bodyBuildingAccountType));
    })  
    .catch((error) => {
...
export const updateBodyBuildingAccountType = (bodyBuildingAccountType) => (dispatch) => {
  dispatch(actions.startCall({ callType: callTypes.action }));
  return requestFromServer  
    .updateBodyBuildingAccountType(bodyBuildingAccountType)  
    .then((response) => {
      dispatch(actions.bodyBuildingAccountTypeUpdated({ bodyBuildingAccountType }));
    })  
    .catch((error) => {
...
export const updateBodyBuildingAccountTypesStatus = (ids, status) => (dispatch) => {
  dispatch(actions.startCall({ callType: callTypes.action }));
  return requestFromServer  
    .updateStatusForBodyBuildingAccountTypes(ids, status)  
    .then(() => {
      dispatch(actions.bodyBuildingAccountTypesStatusUpdated({ ids, status }));
    })  
    .catch((error) => {

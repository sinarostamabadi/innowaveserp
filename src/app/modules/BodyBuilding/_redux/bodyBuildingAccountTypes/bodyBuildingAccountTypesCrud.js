...
export function createBodyBuildingAccountType(bodyBuildingAccountTypes) {
  return axios.post(
    `${BODYBUILDINGACCOUNTTYPES_URL}/post`,
    bodyBuildingAccountTypes
  );
}
// READ
...
export function getBodyBuildingAccountTypeById(bodyBuildingAccountTypesId) {
  return axios.get(
    `${BODYBUILDINGACCOUNTTYPES_URL}/get/${bodyBuildingAccountTypesId}`
  );
}
...
export function updateBodyBuildingAccountType(id, bodyBuildingAccountTypes) {
  return axios.put(
    `${BODYBUILDINGACCOUNTTYPES_URL}/put/${id}`,
    bodyBuildingAccountTypes
  );
}
// UPDATE Status
export function updateStatusForBodyBuildingAccountTypes(ids, status) {
  return axios.post(
    `${BODYBUILDINGACCOUNTTYPES_URL}/updateStatusForBodyBuildingAccountTypes`,
    {
      ids,
      status,
    }
...
export function deleteBodyBuildingAccountType(bodyBuildingAccountTypesId) {
  return axios.delete(
    `${BODYBUILDINGACCOUNTTYPES_URL}/delete/${bodyBuildingAccountTypesId}`
  );
}
// DELETE BodyBuildingAccountTypes by ids
export function deleteBodyBuildingAccountTypes(ids) {
  return axios.post(
    `${BODYBUILDINGACCOUNTTYPES_URL}/deleteBodyBuildingAccountTypes`,
    ids
  );
}

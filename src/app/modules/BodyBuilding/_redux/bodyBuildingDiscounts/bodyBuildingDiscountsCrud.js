...
export function getBodyBuildingDiscountById(bodyBuildingDiscountsId) {
  return axios.get(
    `${BODYBUILDINGDISCOUNTS_URL}/get/${bodyBuildingDiscountsId}`
  );
}
...
export function updateBodyBuildingDiscount(id, bodyBuildingDiscounts) {
  return axios.put(
    `${BODYBUILDINGDISCOUNTS_URL}/put/${id}`,
    bodyBuildingDiscounts
  );
}
// UPDATE Status
export function updateStatusForBodyBuildingDiscounts(ids, status) {
  return axios.post(
    `${BODYBUILDINGDISCOUNTS_URL}/updateStatusForBodyBuildingDiscounts`,
    {
      ids,
      status,
    }
...
export function deleteBodyBuildingDiscount(bodyBuildingDiscountsId) {
  return axios.delete(
    `${BODYBUILDINGDISCOUNTS_URL}/delete/${bodyBuildingDiscountsId}`
  );
}
// DELETE BodyBuildingDiscounts by ids
export function deleteBodyBuildingDiscounts(ids) {
  return axios.post(
    `${BODYBUILDINGDISCOUNTS_URL}/deleteBodyBuildingDiscounts`,
    ids
  );
}

...
export function updateStatusForBodyBuildingCenters(ids, status) {
  return axios.post(`${BODYBUILDINGCENTERS_URL}/updateStatusForBodyBuildingCenters`, {
    ids,
    status,
  });
}
...
export function deleteBodyBuildingCenter(bodyBuildingCentersId) {
  return axios.delete(`${BODYBUILDINGCENTERS_URL}/delete/${bodyBuildingCentersId}`);
}
// DELETE BodyBuildingCenters by ids  
export function deleteBodyBuildingCenters(ids) {
return axios.post(`${BODYBUILDINGCENTERS_URL}/deleteBodyBuildingCenters`, ids);
}
...
export const bodyBuildingCentersSlice = createSlice({
  ...
  reducers: {
    ...
    bodyBuildingCenterFetched: (state, action) => {
      state.actionsLoading = false;
      state.bodyBuildingCenterForEdit =
        action.payload.bodyBuildingCenterForEdit;
      state.error = null;
    },
    ...
    bodyBuildingCenterUpdated: (state, action) => {
      ...
      state.entities = state.entities.map((entity) => {
        if (
          entity.BodyBuildingCenterId ===
          action.payload.bodyBuildingCenter.BodyBuildingCenterId
        ) {

...
export function updateBodyBuildingReserve(id, bodyBuildingReserves) {
  return axios.put(
    `${BODYBUILDINGRESERVES_URL}/put/${id}`,
    bodyBuildingReserves
  );
}
// UPDATE Status
export function updateStatusForBodyBuildingReserves(ids, status) {
  return axios.post(
    `${BODYBUILDINGRESERVES_URL}/updateStatusForBodyBuildingReserves`,
    {
      ids,
      status,
    }
...
export function deleteBodyBuildingReserve(bodyBuildingReservesId) {
  return axios.delete(
    `${BODYBUILDINGRESERVES_URL}/delete/${bodyBuildingReservesId}`
  );
}
// DELETE BodyBuildingReserves by ids
export function deleteBodyBuildingReserves(ids) {
  return axios.post(
    `${BODYBUILDINGRESERVES_URL}/deleteBodyBuildingReserves`,
    ids
  );
}

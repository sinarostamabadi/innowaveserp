...
export function ActionsColumnFormatter(
  ...
  row,
  rowIndex,
  { openEditExpertiseDialog, openDeleteExpertiseDialog, t }
) {
  return (
    <>
      <OverlayTrigger
      ...
      >
        <a
          ...
          onClick={() => openEditExpertiseDialog(row.BodyBuildingEmployeeTypeExpertiseId)}
        >
      ...
      >
        <a
          ...
          onClick={() => {
            openDeleteExpertiseDialog(row.BodyBuildingEmployeeTypeExpertiseId);
          }}
        >

...
export function ActionsColumnFormatter(
  ...
  row,
  rowIndex,
  { openEditEmployeeTypeDialog, openDeleteEmployeeTypeDialog, t }
) {
  return (
    <>
      <OverlayTrigger
      ...
      >
        <a
          ...
          onClick={() => openEditEmployeeTypeDialog(row.BodyBuildingEmployeeExpertiseId)}
        >
      ...
      >
        <a
          ...
          onClick={() => {
            openDeleteEmployeeTypeDialog(row.BodyBuildingEmployeeExpertiseId);
          }}
        >

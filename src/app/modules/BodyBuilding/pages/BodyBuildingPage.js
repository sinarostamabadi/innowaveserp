      ...
      <Switch>
        {
          <Redirect
            exact={true}
            from="/BodyBuilding"
            to="/BodyBuilding/dashboard"
          />
        }

        {/* begin BodyBuildingDashboard */}
        <ContentRoute
          path="/BodyBuilding/dashboard"
          component={BodyBuildingDashboard}
        />
        ...
        <ContentRoute
          path="/BodyBuilding/Closets/:id/edit"
          component={ClosetEdit}
        />
        ...
        {/* begin EmployeeTypes */}
        <ContentRoute
          path="/BodyBuilding/EmployeeTypes/new"
          component={EmployeeTypeEdit}
        />
        <ContentRoute
          path="/BodyBuilding/EmployeeTypes/:id/edit"
          component={EmployeeTypeEdit}
        />
        <ContentRoute
          path="/BodyBuilding/EmployeeTypes"
        ...
        <ContentRoute
          path="/BodyBuilding/Packs/:id/edit"
          component={PackEdit}
        />
        ...
        {/* begin TimeSets */}
        <ContentRoute
          path="/BodyBuilding/TimeSets/new"
          component={TimeSetEdit}
        />
        <ContentRoute
          path="/BodyBuilding/TimeSets/:id/edit"
          component={TimeSetEdit}
        />
        ...
        {/* begin Services */}
        <ContentRoute
          path="/BodyBuilding/Services/new"
          component={ServiceEdit}
        />
        <ContentRoute
          path="/BodyBuilding/Services/:id/edit"
          component={ServiceEdit}
        />
        ...
        {/* begin Discounts */}
        <ContentRoute
          path="/BodyBuilding/Discounts/new"
          component={DiscountEdit}
        />
        <ContentRoute
          path="/BodyBuilding/Discounts/:id/edit"
          component={DiscountEdit}
        />
        <ContentRoute
          path="/BodyBuilding/Discounts"
        ...
        {/* begin Employees */}
        <ContentRoute
          path="/BodyBuilding/Employees/new"
          component={EmployeeEdit}
        />
        <ContentRoute
          path="/BodyBuilding/Employees/:id/edit"
          component={EmployeeEdit}
        />
        <ContentRoute
          path="/BodyBuilding/Employees"
        ...
        {/* begin Employees */}
        <ContentRoute
          path="/BodyBuilding/Contracts/new"
          component={ContractEdit}
        />
        <ContentRoute
          path="/BodyBuilding/Contracts/:id/edit"
          component={ContractEdit}
        />
        <ContentRoute
          path="/BodyBuilding/Contracts"

...
export function ActionsColumnFormatter(
  ...
  row,
  rowIndex,
  { openEditServiceDialog, openDeleteServiceDialog, t }
) {
  return (
    <>
      <OverlayTrigger
      ...
      >
        <a
          ...
          onClick={() => openEditServiceDialog(row.BodyBuildingPackServiceId)}
        >
      ...
      >
        <a
          ...
          onClick={() => {
            openDeleteServiceDialog(row.BodyBuildingPackServiceId);
          }}
        >

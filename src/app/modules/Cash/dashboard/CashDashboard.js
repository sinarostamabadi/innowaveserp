...
export function CashDashboard() {
  return (
    <>
      ...
      >
        <Col xs="12" style={{ minHeight: "500px" }}>
          <div
          ...
          >
            <div className="card-header">
              <div className="card-title">
                <h3 className="card-label">Cash information</h3>
              </div>
            </div>
            <div className="card-body">
              <ServiceAccessShow dashboardId="3000"></ServiceAccessShow>

              <img
                alt="logo"
                src="/media/modules/cash.png"
                style={{
                  position: "absolute",
                  bottom: "1rem",
                  left: "1rem",

...
import { ChequeTools } from "../Dependency";

export function Cheque({ data, setData, receivable, goBack }) {
              ...
              <div className="row mt-2">
                ...
                <div className="col-lg-6">
                  <Field
                    ...
                    isLtr={true}
                    customFeedbackLabel=""
                    label={t("CashDocument.ChequeNumber")}
                  />
                </div>
              </div>
              <div className="row mt-2">
                ...
                <div className="col-lg-6">
                  <Field
                    ...
                    component={Input}
                    customFeedbackLabel=""
                    label={t("CashDocument.BranchName")}
                  />
                </div>
              </div>
              <div className="row mt-2">
                <div className="col-lg-6">
                  <Field
                    ...
                    isLtr={true}
                    customFeedbackLabel=""
                    label={t("CashDocument.AccountNumber")}
                  />
                </div>
                <div className="col-lg-6">
                  <DatePickerField
              ...
              <div className="row mt-2">
                <div className="col-6">
                  <Field
                    ...
                    component={Input}
                    customFeedbackLabel=""
                    label={t("CashDocument.ChequePayable")}
                  />
                </div>
                <div className="col">
                  <CheckboxField
                    name="IsPromissory"
                    customFeedbackLabel=""
                    label={t("CashDocument.IsPromissory")}
                  />
                </div>
                <div className="col">
                  <CheckboxField

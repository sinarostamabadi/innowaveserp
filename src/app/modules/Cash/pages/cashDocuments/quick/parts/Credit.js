...
import { CreditTools } from "../Dependency";

export function Credit({ data, setData, receivable, goBack }) {
  ...
  let cashDocument = { ...CreditTools.Model, Price: receivable };

  function saveCashDocument(dirty) {
    let obj = { ...CreditTools.Clean(dirty) };

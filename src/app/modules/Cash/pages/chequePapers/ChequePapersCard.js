...
import {
  useChequePapersUIContext,
  ChequePapersUIConsumer,
} from "./ChequePapersUIContext";
  ...
  const chequePapersUIProps = useMemo(() => {
    return {
      ...
      newChequePaperButtonClick:
        chequePapersUIContext.newChequePaperButtonClick,
      openDeleteChequePapersDialog:
        chequePapersUIContext.openDeleteChequePapersDialog,
      openEditChequePaperPage: chequePapersUIContext.openEditChequePaperPage,
      openUpdateChequePapersStatusDialog:
        chequePapersUIContext.openUpdateChequePapersStatusDialog,
      openFetchChequePapersDialog:
        chequePapersUIContext.openFetchChequePapersDialog,
    };

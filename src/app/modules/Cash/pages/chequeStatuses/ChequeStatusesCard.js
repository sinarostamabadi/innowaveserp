...
import {
  useChequeStatusesUIContext,
  ChequeStatusesUIConsumer,
} from "./ChequeStatusesUIContext";
  ...
  const chequeStatusesUIProps = useMemo(() => {
    return {
      ...
      newChequeStatusButtonClick:
        chequeStatusesUIContext.newChequeStatusButtonClick,
      openDeleteChequeStatusesDialog:
        chequeStatusesUIContext.openDeleteChequeStatusesDialog,
      openEditChequeStatusPage:
        chequeStatusesUIContext.openEditChequeStatusPage,
      openUpdateChequeStatusesStatusDialog:
        chequeStatusesUIContext.openUpdateChequeStatusesStatusDialog,
      openFetchChequeStatusesDialog:
        chequeStatusesUIContext.openFetchChequeStatusesDialog,
    };

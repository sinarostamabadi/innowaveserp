...
export const ActionsColumnFormatter = (
  ...
  <>
    <OverlayTrigger overlay={<Tooltip id="operationTypes-edit-tooltip">{t("Common.Edit")}</Tooltip>}>
      <a
    ...
    <> </>
    <OverlayTrigger
      overlay={<Tooltip id="operationTypes-delete-tooltip">{t("Common.Delete")}</Tooltip>}
    >
      <a

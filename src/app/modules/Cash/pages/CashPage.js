  ...
  return (
    <Suspense fallback={<LayoutSplashScreen />}>
      <Switch>
        ...
        <ContentRoute
          path="/Cash/cashDocuments/new"
          component={CashDocumentEdit}
        />
        <ContentRoute
          path="/Cash/cashDocuments/:id/edit"
          component={CashDocumentEdit}
        />
        <ContentRoute
          path="/Cash/cashDocuments"
          component={CashDocumentsPage}
        />
        {/* end CashDocuments */}

        {/* begin PosTransactions */}
        <ContentRoute
          path="/Cash/posTransactions/new"
          component={PosTransactionEdit}
        />
        <ContentRoute
          path="/Cash/posTransactions/:id/edit"
          component={PosTransactionEdit}
        />
        <ContentRoute
          path="/Cash/posTransactions"
          component={PosTransactionsPage}
        />
        {/* end PosTransactions */}
        ...
        <ContentRoute
          path="/Cash/chequeBooks/:id/edit"
          component={ChequeBookEdit}
        />
        ...
        {/* begin ChequePapers */}
        <ContentRoute
          path="/Cash/chequePapers/new"
          component={ChequePaperEdit}
        />
        <ContentRoute
          path="/Cash/chequePapers/:id/edit"
          component={ChequePaperEdit}
        />

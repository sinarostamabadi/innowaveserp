...
export function ChequePaperEditForm({ saveChequePaper, chequePaper, actionsLoading, onHide }) {
  ...
  function clean(dirty) {
    return {
      ...
      ChequePaperStatus: dirty.ChequePaperStatus == null || dirty.ChequePaperStatus == "" ? null : +dirty.ChequePaperStatus,

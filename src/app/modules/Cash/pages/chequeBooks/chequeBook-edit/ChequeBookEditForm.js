  ...
  ({ chequeBook, btnRef, editmode }, ref) => {
    ...
    const ChequeBookEditSchema = Yup.object().shape({
      BankAccountId: Yup.array().required(
        t("err.IsRequired", { 0: t("ChequeBook.BankAccountId") })
      ),
      ChequeBookStatus: Yup.string().required(
        t("err.IsRequired", { 0: t("ChequeBook.ChequeBookStatus") })
      ),
      Serial: Yup.string().required(
        t("err.IsRequired", { 0: t("ChequeBook.Serial") })
      ),
      Count: Yup.number().required(
        t("err.IsRequired", { 0: t("ChequeBook.Count") })
      ),
    });

...
export function updateCashTransactionType(id, cashTransactionTypes) {
  return axios.put(`${CASHTRANSACTIONTYPES_URL}/put/${id}`, cashTransactionTypes);
}
// UPDATE Status  
export function updateStatusForCashTransactionTypes(ids, status) {
  return axios.post(`${CASHTRANSACTIONTYPES_URL}/updateStatusForCashTransactionTypes`, {
    ids,
    status,
  });
}
...
export function deleteCashTransactionType(cashTransactionTypesId) {
  return axios.delete(`${CASHTRANSACTIONTYPES_URL}/delete/${cashTransactionTypesId}`);
}
// DELETE CashTransactionTypes by ids  
export function deleteCashTransactionTypes(ids) {
return axios.post(`${CASHTRANSACTIONTYPES_URL}/deleteCashTransactionTypes`, ids);
}
...
export const fetchSettlementTypes = (queryParams) => (dispatch) => {
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.settlementTypesFetched({
...
export const fetchSettlementType = (id) => (dispatch) => {
  if (!id) {
    return dispatch(
      actions.settlementTypeFetched({ settlementTypeForEdit: undefined })
    );
  }
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.settlementTypeFetched({ settlementTypeForEdit: settlementType })
      );
    })
    .catch((error) => {
...
export const createSettlementType =
  (settlementTypeForCreation) => (dispatch) => {
    dispatch(actions.startCall({ callType: callTypes.action }));
    return requestFromServer

...
import {
  operationTypeAccountsSlice,
  callTypes,
} from "./operationTypeAccountsSlice";
...
export const fetchOperationTypeAccounts = (queryParams) => (dispatch) => {
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.operationTypeAccountsFetched({
...
export const fetchOperationTypeAccount = (id) => (dispatch) => {
  if (!id) {
    return dispatch(
      actions.operationTypeAccountFetched({
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.operationTypeAccountFetched({
          operationTypeAccountForEdit: operationTypeAccount,
        })
      );
    })
    .catch((error) => {
...
export const createOperationTypeAccount =
  (operationTypeAccountForCreation) => (dispatch) => {
    dispatch(actions.startCall({ callType: callTypes.action }));
    return requestFromServer
...
export const updateOperationTypeAccount =
  (operationTypeAccount) => (dispatch) => {
    dispatch(actions.startCall({ callType: callTypes.action }));
    return requestFromServer
...
export const updateOperationTypeAccountsStatus =
  (ids, status) => (dispatch) => {
    dispatch(actions.startCall({ callType: callTypes.action }));
    return requestFromServer

...
export function getOperationTypeAccountById(operationTypeAccountsId) {
  return axios.get(`${OPERATIONTYPEACCOUNTS_URL}/get/${operationTypeAccountsId}`);
}
...
export function updateOperationTypeAccount(id, operationTypeAccounts) {
  return axios.put(`${OPERATIONTYPEACCOUNTS_URL}/put/${id}`, operationTypeAccounts);
}
// UPDATE Status  
export function updateStatusForOperationTypeAccounts(ids, status) {
  return axios.post(`${OPERATIONTYPEACCOUNTS_URL}/updateStatusForOperationTypeAccounts`, {
    ids,
    status,
  });
}
...
export function deleteOperationTypeAccount(operationTypeAccountsId) {
  return axios.delete(`${OPERATIONTYPEACCOUNTS_URL}/delete/${operationTypeAccountsId}`);
}
// DELETE OperationTypeAccounts by ids  
export function deleteOperationTypeAccounts(ids) {
return axios.post(`${OPERATIONTYPEACCOUNTS_URL}/deleteOperationTypeAccounts`, ids);
}
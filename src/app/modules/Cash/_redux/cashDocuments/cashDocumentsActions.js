...
export const fetchCashDocuments = (queryParams) => (dispatch) => {
  ...
  return requestFromServer  
    ...
    .then((response) => {
      ...
      dispatch(
        actions.cashDocumentsFetched({ totalCount: TotalCount, entities: Items })  
      );
    })  
    .catch((error) => {
...
export const fetchCashDocument = (id) => (dispatch) => {
  if (!id) {
    return dispatch(actions.cashDocumentFetched({ cashDocumentForEdit: undefined }));
  }
  ...
  return requestFromServer  
    ...
    .then((response) => {
      ...
      dispatch(actions.cashDocumentFetched({ cashDocumentForEdit: cashDocument }));
    })  
    .catch((error) => {

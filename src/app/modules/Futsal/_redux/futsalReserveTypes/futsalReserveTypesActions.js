...
export const fetchFutsalReserveTypes = (queryParams) => (dispatch) => {
  ...
  return requestFromServer  
    ...
    .then((response) => {
      ...
      dispatch(
        actions.futsalReserveTypesFetched({ totalCount: TotalCount, entities: Items })  
      );
    })  
    .catch((error) => {
...
export const fetchFutsalReserveType = (id) => (dispatch) => {
  if (!id) {
    return dispatch(actions.futsalReserveTypeFetched({ futsalReserveTypeForEdit: undefined }));
  }
  ...
  return requestFromServer  
    ...
    .then((response) => {
      ...
      dispatch(actions.futsalReserveTypeFetched({ futsalReserveTypeForEdit: futsalReserveType }));
    })  
    .catch((error) => {
...
export const createFutsalReserveType = (futsalReserveTypeForCreation) => (dispatch) => {
  dispatch(actions.startCall({ callType: callTypes.action }));
  return requestFromServer  

...
export const fetchFutsalTimePriceings = (queryParams) => (dispatch) => {
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.futsalTimePriceingsFetched({
...
export const fetchFutsalTimePriceing = (id) => (dispatch) => {
  if (!id) {
    return dispatch(
      actions.futsalTimePriceingFetched({
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.futsalTimePriceingFetched({
          futsalTimePriceingForEdit: futsalTimePriceing,
        })
      );
    })
    .catch((error) => {
...
export const createFutsalTimePriceing =
  (futsalTimePriceingForCreation) => (dispatch) => {
    dispatch(actions.startCall({ callType: callTypes.action }));
    return requestFromServer

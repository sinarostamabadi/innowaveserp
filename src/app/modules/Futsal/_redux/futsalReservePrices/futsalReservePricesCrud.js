...
export function updateStatusForFutsalReservePrices(ids, status) {
  return axios.post(
    `${FUTSALRESERVEPRICES_URL}/updateStatusForFutsalReservePrices`,
    {
      ids,
      status,
    }
...
export function deleteFutsalReservePrice(futsalReservePricesId) {
  return axios.delete(
    `${FUTSALRESERVEPRICES_URL}/delete/${futsalReservePricesId}`
  );
}
// DELETE FutsalReservePrices by ids
export function deleteFutsalReservePrices(ids) {
  return axios.post(
    `${FUTSALRESERVEPRICES_URL}/deleteFutsalReservePrices`,
    ids
  );
}

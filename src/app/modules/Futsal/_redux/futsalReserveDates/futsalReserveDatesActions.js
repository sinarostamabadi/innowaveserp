...
export const fetchFutsalReserveDates = (queryParams) => (dispatch) => {
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.futsalReserveDatesFetched({
...
export const fetchFutsalReserveDate = (id) => (dispatch) => {
  if (!id) {
    return dispatch(
      actions.futsalReserveDateFetched({ futsalReserveDateForEdit: undefined })
    );
  }
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.futsalReserveDateFetched({
          futsalReserveDateForEdit: futsalReserveDate,
        })
      );
    })
    .catch((error) => {
...
export const createFutsalReserveDate =
  (futsalReserveDateForCreation) => (dispatch) => {
    dispatch(actions.startCall({ callType: callTypes.action }));
    return requestFromServer

...
export const fetchFutsalReserves = (queryParams) => (dispatch) => {
  ...
  return requestFromServer  
    ...
    .then((response) => {
      ...
      dispatch(
        actions.futsalReservesFetched({ totalCount: TotalCount, entities: Items })  
      );
    })  
    .catch((error) => {
...
export const fetchFutsalReserve = (id) => (dispatch) => {
  if (!id) {
    return dispatch(actions.futsalReserveFetched({ futsalReserveForEdit: undefined }));
  }
  ...
  return requestFromServer  
    ...
    .then((response) => {
      ...
      dispatch(actions.futsalReserveFetched({ futsalReserveForEdit: futsalReserve }));
    })  
    .catch((error) => {

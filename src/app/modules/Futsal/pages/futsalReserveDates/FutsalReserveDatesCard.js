...
import { useFutsalReserveDatesUIContext, FutsalReserveDatesUIConsumer } from "./FutsalReserveDatesUIContext";
...
export function FutsalReserveDatesCard() {
  ...
  const futsalReserveDatesUIProps = useMemo(() => {
    return {
      ...
      newFutsalReserveDateButtonClick: futsalReserveDatesUIContext.newFutsalReserveDateButtonClick,
      openDeleteFutsalReserveDatesDialog: futsalReserveDatesUIContext.openDeleteFutsalReserveDatesDialog,
      openEditFutsalReserveDatePage: futsalReserveDatesUIContext.openEditFutsalReserveDatePage,
      openUpdateFutsalReserveDatesStatusDialog: futsalReserveDatesUIContext.openUpdateFutsalReserveDatesStatusDialog,
      openFetchFutsalReserveDatesDialog: futsalReserveDatesUIContext.openFetchFutsalReserveDatesDialog,
    };
  }, [futsalReserveDatesUIContext]);

  return (
    <Card>
      <CardHeader title={t("Common.List") + ' ' + t("FutsalReserveDate.Entity")}>
        <CardHeaderToolbar>
          <button
            type="button"

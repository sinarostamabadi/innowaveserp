...
import { useFutsalCentersUIContext, FutsalCentersUIConsumer } from "./FutsalCentersUIContext";
...
export function FutsalCentersCard() {
  ...
  const futsalCentersUIProps = useMemo(() => {
    return {
      ...
      newFutsalCenterButtonClick: futsalCentersUIContext.newFutsalCenterButtonClick,
      openDeleteFutsalCentersDialog: futsalCentersUIContext.openDeleteFutsalCentersDialog,
      openEditFutsalCenterPage: futsalCentersUIContext.openEditFutsalCenterPage,
      openUpdateFutsalCentersStatusDialog: futsalCentersUIContext.openUpdateFutsalCentersStatusDialog,
      openFetchFutsalCentersDialog: futsalCentersUIContext.openFetchFutsalCentersDialog,
    };

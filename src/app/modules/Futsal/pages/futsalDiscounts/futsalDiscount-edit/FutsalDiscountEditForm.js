  ...
  return (
    <>
      <Formik
        ...
        initialValues={futsalDiscount}
        validationSchema={FutsalDiscountEditSchema}
        onSubmit={(values) => {
          saveFutsalDiscount(values);
        }}
      >
        {({ handleSubmit }) => (
          <>
              ...
              <div className="form-group row">
                <div className="col-lg-6">
                  <Field
                    ...
                    component={Input}
                    customFeedbackLabel=""
                    label={t("FutsalDiscount.TitleFa")}
                  />
                </div>
                <div className="col-lg-6">
                  <Field
                    ...
                    component={Input}
                    customFeedbackLabel=""
                    label={t("FutsalDiscount.TitleEn")}
                  />
                </div>
              </div>
              <button

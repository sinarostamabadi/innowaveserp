...
export function updateStatusForRestaurantCostTypes(ids, status) {
  return axios.post(
    `${RESTAURANTCOSTTYPES_URL}/updateStatusForRestaurantCostTypes`,
    {
      ids,
      status,
    }
...
export function deleteRestaurantCostType(restaurantCostTypesId) {
  return axios.delete(
    `${RESTAURANTCOSTTYPES_URL}/delete/${restaurantCostTypesId}`
  );
}
// DELETE RestaurantCostTypes by ids
export function deleteRestaurantCostTypes(ids) {
  return axios.post(
    `${RESTAURANTCOSTTYPES_URL}/deleteRestaurantCostTypes`,
    ids
  );
}

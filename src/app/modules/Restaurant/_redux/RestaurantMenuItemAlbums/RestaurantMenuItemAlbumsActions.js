...
import {
  restaurantMenuItemAlbumsSlice,
  callTypes,
} from "./restaurantMenuItemAlbumsSlice";
...
export const fetchRestaurantMenuItemAlbums = (queryParams) => (dispatch) => {
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.restaurantMenuItemAlbumsFetched({
...
export const fetchRestaurantMenuItemAlbum = (id) => (dispatch) => {
  if (!id) {
    return dispatch(
      actions.restaurantMenuItemAlbumFetched({
  ...
  return requestFromServer
    ...
    .then((response) => {
      ...
      dispatch(
        actions.restaurantMenuItemAlbumFetched({
          restaurantMenuItemAlbumForEdit: restaurantMenuItemAlbum,
        })
      );
    })
    .catch((error) => {
...
export const createRestaurantMenuItemAlbum =
  (restaurantMenuItemAlbumForCreation) => (dispatch) => {
    dispatch(actions.startCall({ callType: callTypes.action }));
    return requestFromServer
      ...
      .then((response) => {
        const restaurantMenuItemAlbum = response.data;
        dispatch(
          actions.restaurantMenuItemAlbumCreated(restaurantMenuItemAlbum)
        );
      })
      .catch((error) => {
...
export const updateRestaurantMenuItemAlbum =
  (restaurantMenuItemAlbum) => (dispatch) => {
    dispatch(actions.startCall({ callType: callTypes.action }));
    return requestFromServer
      .updateRestaurantMenuItemAlbum(restaurantMenuItemAlbum)
      .then((response) => {
        dispatch(
          actions.restaurantMenuItemAlbumUpdated({ restaurantMenuItemAlbum })
        );
      })
      .catch((error) => {
...
export const updateRestaurantMenuItemAlbumsStatus =
  (ids, status) => (dispatch) => {
    dispatch(actions.startCall({ callType: callTypes.action }));
    return requestFromServer
      ...
      .then(() => {
        dispatch(
          actions.restaurantMenuItemAlbumsStatusUpdated({ ids, status })
        );
      })
      .catch((error) => {

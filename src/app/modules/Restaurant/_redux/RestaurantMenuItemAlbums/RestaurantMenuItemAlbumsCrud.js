...
export function createRestaurantMenuItemAlbum(restaurantMenuItemAlbums) { 
  return axios.post(`${RESTAURANTMENUITEMALBUMS_URL}/post`, restaurantMenuItemAlbums); 
}
// READ  
...
export function getRestaurantMenuItemAlbumById(restaurantMenuItemAlbumsId) {
  return axios.get(`${RESTAURANTMENUITEMALBUMS_URL}/get/${restaurantMenuItemAlbumsId}`);
}
...
export function updateRestaurantMenuItemAlbum(id, restaurantMenuItemAlbums) {
  return axios.put(`${RESTAURANTMENUITEMALBUMS_URL}/put/${id}`, restaurantMenuItemAlbums);
}
// UPDATE Status  
export function updateStatusForRestaurantMenuItemAlbums(ids, status) {
  return axios.post(`${RESTAURANTMENUITEMALBUMS_URL}/updateStatusForRestaurantMenuItemAlbums`, {
    ids,
    status,
  });
}
...
export function deleteRestaurantMenuItemAlbum(restaurantMenuItemAlbumsId) {
  return axios.delete(`${RESTAURANTMENUITEMALBUMS_URL}/delete/${restaurantMenuItemAlbumsId}`);
}
// DELETE RestaurantMenuItemAlbums by ids  
export function deleteRestaurantMenuItemAlbums(ids) {
return axios.post(`${RESTAURANTMENUITEMALBUMS_URL}/deleteRestaurantMenuItemAlbums`, ids);
}
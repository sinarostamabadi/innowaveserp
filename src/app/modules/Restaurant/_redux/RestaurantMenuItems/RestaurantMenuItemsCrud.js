...
export function updateStatusForRestaurantMenuItems(ids, status) {
  return axios.post(
    `${RESTAURANTMENUITEMS_URL}/updateStatusForRestaurantMenuItems`,
    {
      ids,
      status,
    }
...
export function deleteRestaurantMenuItem(restaurantMenuItemsId) {
  return axios.delete(
    `${RESTAURANTMENUITEMS_URL}/delete/${restaurantMenuItemsId}`
  );
}
// DELETE RestaurantMenuItems by ids
export function deleteRestaurantMenuItems(ids) {
  return axios.post(
    `${RESTAURANTMENUITEMS_URL}/deleteRestaurantMenuItems`,
    ids
  );
}

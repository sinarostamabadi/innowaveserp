...
export function updateRestaurantMenuGroup(id, restaurantMenuGroups) {
  return axios.put(`${RESTAURANTMENUGROUPS_URL}/put/${id}`, restaurantMenuGroups);
}
// UPDATE Status  
export function updateStatusForRestaurantMenuGroups(ids, status) {
  return axios.post(`${RESTAURANTMENUGROUPS_URL}/updateStatusForRestaurantMenuGroups`, {
    ids,
    status,
  });
}
...
export function deleteRestaurantMenuGroup(restaurantMenuGroupsId) {
  return axios.delete(`${RESTAURANTMENUGROUPS_URL}/delete/${restaurantMenuGroupsId}`);
}
// DELETE RestaurantMenuGroups by ids  
export function deleteRestaurantMenuGroups(ids) {
return axios.post(`${RESTAURANTMENUGROUPS_URL}/deleteRestaurantMenuGroups`, ids);
}
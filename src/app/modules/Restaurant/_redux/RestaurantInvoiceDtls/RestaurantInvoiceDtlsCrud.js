...
export function getRestaurantInvoiceDtlById(restaurantInvoiceDtlsId) {
  return axios.get(`${RESTAURANTINVOICEDTLS_URL}/get/${restaurantInvoiceDtlsId}`);
}
...
export function updateRestaurantInvoiceDtl(id, restaurantInvoiceDtls) {
  return axios.put(`${RESTAURANTINVOICEDTLS_URL}/put/${id}`, restaurantInvoiceDtls);
}
// UPDATE Status  
export function updateStatusForRestaurantInvoiceDtls(ids, status) {
  return axios.post(`${RESTAURANTINVOICEDTLS_URL}/updateStatusForRestaurantInvoiceDtls`, {
    ids,
    status,
  });
}
...
export function deleteRestaurantInvoiceDtl(restaurantInvoiceDtlsId) {
  return axios.delete(`${RESTAURANTINVOICEDTLS_URL}/delete/${restaurantInvoiceDtlsId}`);
}
// DELETE RestaurantInvoiceDtls by ids  
export function deleteRestaurantInvoiceDtls(ids) {
return axios.post(`${RESTAURANTINVOICEDTLS_URL}/deleteRestaurantInvoiceDtls`, ids);
}
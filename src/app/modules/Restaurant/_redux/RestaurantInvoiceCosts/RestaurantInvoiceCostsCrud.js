...
export function createRestaurantInvoiceCost(restaurantInvoiceCosts) { 
  return axios.post(`${RESTAURANTINVOICECOSTS_URL}/post`, restaurantInvoiceCosts); 
}
// READ  
...
export function getRestaurantInvoiceCostById(restaurantInvoiceCostsId) {
  return axios.get(`${RESTAURANTINVOICECOSTS_URL}/get/${restaurantInvoiceCostsId}`);
}
...
export function updateRestaurantInvoiceCost(id, restaurantInvoiceCosts) {
  return axios.put(`${RESTAURANTINVOICECOSTS_URL}/put/${id}`, restaurantInvoiceCosts);
}
// UPDATE Status  
export function updateStatusForRestaurantInvoiceCosts(ids, status) {
  return axios.post(`${RESTAURANTINVOICECOSTS_URL}/updateStatusForRestaurantInvoiceCosts`, {
    ids,
    status,
  });
}
...
export function deleteRestaurantInvoiceCost(restaurantInvoiceCostsId) {
  return axios.delete(`${RESTAURANTINVOICECOSTS_URL}/delete/${restaurantInvoiceCostsId}`);
}
// DELETE RestaurantInvoiceCosts by ids  
export function deleteRestaurantInvoiceCosts(ids) {
return axios.post(`${RESTAURANTINVOICECOSTS_URL}/deleteRestaurantInvoiceCosts`, ids);
}
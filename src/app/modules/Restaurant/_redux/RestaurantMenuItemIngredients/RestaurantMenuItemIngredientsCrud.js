...
export function createRestaurantMenuItemIngredient(
  restaurantMenuItemIngredients
) {
  return axios.post(
    `${RESTAURANTMENUITEMINGREDIENTS_URL}/post`,
    restaurantMenuItemIngredients
  );
}
// READ
...
export function getRestaurantMenuItemIngredientById(
  restaurantMenuItemIngredientsId
) {
  return axios.get(
    `${RESTAURANTMENUITEMINGREDIENTS_URL}/get/${restaurantMenuItemIngredientsId}`
  );
}
...
export function updateRestaurantMenuItemIngredient(
  id,
  restaurantMenuItemIngredients
) {
  return axios.put(
    `${RESTAURANTMENUITEMINGREDIENTS_URL}/put/${id}`,
    restaurantMenuItemIngredients
  );
}
// UPDATE Status
export function updateStatusForRestaurantMenuItemIngredients(ids, status) {
  return axios.post(
    `${RESTAURANTMENUITEMINGREDIENTS_URL}/updateStatusForRestaurantMenuItemIngredients`,
    {
      ids,
      status,
    }
...
export function deleteRestaurantMenuItemIngredient(
  restaurantMenuItemIngredientsId
) {
  return axios.delete(
    `${RESTAURANTMENUITEMINGREDIENTS_URL}/delete/${restaurantMenuItemIngredientsId}`
  );
}
// DELETE RestaurantMenuItemIngredients by ids
export function deleteRestaurantMenuItemIngredients(ids) {
  return axios.post(
    `${RESTAURANTMENUITEMINGREDIENTS_URL}/deleteRestaurantMenuItemIngredients`,
    ids
  );
}

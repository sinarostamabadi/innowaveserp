...
export function createRestaurantDiscountType(restaurantDiscountTypes) { 
  return axios.post(`${RESTAURANTDISCOUNTTYPES_URL}/post`, restaurantDiscountTypes); 
}
// READ  
...
export function getRestaurantDiscountTypeById(restaurantDiscountTypesId) {
  return axios.get(`${RESTAURANTDISCOUNTTYPES_URL}/get/${restaurantDiscountTypesId}`);
}
...
export function updateRestaurantDiscountType(id, restaurantDiscountTypes) {
  return axios.put(`${RESTAURANTDISCOUNTTYPES_URL}/put/${id}`, restaurantDiscountTypes);
}
// UPDATE Status  
export function updateStatusForRestaurantDiscountTypes(ids, status) {
  return axios.post(`${RESTAURANTDISCOUNTTYPES_URL}/updateStatusForRestaurantDiscountTypes`, {
    ids,
    status,
  });
}
...
export function deleteRestaurantDiscountType(restaurantDiscountTypesId) {
  return axios.delete(`${RESTAURANTDISCOUNTTYPES_URL}/delete/${restaurantDiscountTypesId}`);
}
// DELETE RestaurantDiscountTypes by ids  
export function deleteRestaurantDiscountTypes(ids) {
return axios.post(`${RESTAURANTDISCOUNTTYPES_URL}/deleteRestaurantDiscountTypes`, ids);
}
...
import { restaurantDiscountTypesSlice, callTypes } from "./RestaurantDiscountTypesSlice";
...
export const fetchRestaurantDiscountTypes = (queryParams) => (dispatch) => {
  ...
  return requestFromServer  
    ...
    .then((response) => {
      ...
      dispatch(
        actions.restaurantDiscountTypesFetched({ totalCount: TotalCount, entities: Items })  
      );
    })  
    .catch((error) => {
...
export const fetchRestaurantDiscountType = (id) => (dispatch) => {
  if (!id) {
    return dispatch(actions.restaurantDiscountTypeFetched({ restaurantDiscountTypeForEdit: undefined }));
  }
  ...
  return requestFromServer  
    ...
    .then((response) => {
      ...
      if (!!restaurantDiscountType) {
        restaurantDiscountType.Price = !!restaurantDiscountType.Price ? restaurantDiscountType.Price: "";
        restaurantDiscountType.DiscountPercent = !!restaurantDiscountType.DiscountPercent ? restaurantDiscountType.DiscountPercent: "";
        ...
        restaurantDiscountType["FromTimeObj"] = moment(restaurantDiscountType["FromTimeObj"], 'hh:mm:ss');
        restaurantDiscountType["ToTimeObj"] = moment(restaurantDiscountType["ToTimeObj"], 'hh:mm:ss');

        restaurantDiscountType["FromDateObj"] = EnToFaObjDate(restaurantDiscountType.FromDate);
        restaurantDiscountType["ToDateObj"] = EnToFaObjDate(restaurantDiscountType.ToDate);         
      }

      dispatch(actions.restaurantDiscountTypeFetched({ restaurantDiscountTypeForEdit: restaurantDiscountType }));
    })  
    .catch((error) => {
...
export const createRestaurantDiscountType = (restaurantDiscountTypeForCreation, fnCallback) => (dispatch) => {
  dispatch(actions.startCall({ callType: callTypes.action }));
  return requestFromServer  
...
export const updateRestaurantDiscountType = (id, restaurantDiscountType, fnCallback) => (dispatch) => {
  dispatch(actions.startCall({ callType: callTypes.action }));
  return requestFromServer  
    .updateRestaurantDiscountType(id, restaurantDiscountType)  
    .then((response) => {
      fnCallback();
      dispatch(actions.restaurantDiscountTypeUpdated({ restaurantDiscountType }));
    })  
    .catch((error) => {
...
export const updateRestaurantDiscountTypesStatus = (ids, status) => (dispatch) => {
  dispatch(actions.startCall({ callType: callTypes.action }));
  return requestFromServer  

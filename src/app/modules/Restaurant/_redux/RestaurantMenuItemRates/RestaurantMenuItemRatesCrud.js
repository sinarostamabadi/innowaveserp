...
export function createRestaurantMenuItemRate(restaurantMenuItemRates) { 
  return axios.post(`${RESTAURANTMENUITEMRATES_URL}/post`, restaurantMenuItemRates); 
}
// READ  
...
export function getRestaurantMenuItemRateById(restaurantMenuItemRatesId) {
  return axios.get(`${RESTAURANTMENUITEMRATES_URL}/get/${restaurantMenuItemRatesId}`);
}
...
export function updateRestaurantMenuItemRate(id, restaurantMenuItemRates) {
  return axios.put(`${RESTAURANTMENUITEMRATES_URL}/put/${id}`, restaurantMenuItemRates);
}
// UPDATE Status  
export function updateStatusForRestaurantMenuItemRates(ids, status) {
  return axios.post(`${RESTAURANTMENUITEMRATES_URL}/updateStatusForRestaurantMenuItemRates`, {
    ids,
    status,
  });
}
...
export function deleteRestaurantMenuItemRate(restaurantMenuItemRatesId) {
  return axios.delete(`${RESTAURANTMENUITEMRATES_URL}/delete/${restaurantMenuItemRatesId}`);
}
// DELETE RestaurantMenuItemRates by ids  
export function deleteRestaurantMenuItemRates(ids) {
return axios.post(`${RESTAURANTMENUITEMRATES_URL}/deleteRestaurantMenuItemRates`, ids);
}
...
export function updateStatusForPlaceOfPreparations(ids, status) {
  return axios.post(
    `${PLACEOFPREPARATIONS_URL}/updateStatusForPlaceOfPreparations`,
    {
      ids,
      status,
    }
...
export function deletePlaceOfPreparation(placeOfPreparationsId) {
  return axios.delete(
    `${PLACEOFPREPARATIONS_URL}/delete/${placeOfPreparationsId}`
  );
}
// DELETE PlaceOfPreparations by ids
export function deletePlaceOfPreparations(ids) {
  return axios.post(
    `${PLACEOFPREPARATIONS_URL}/deletePlaceOfPreparations`,
    ids
  );
}

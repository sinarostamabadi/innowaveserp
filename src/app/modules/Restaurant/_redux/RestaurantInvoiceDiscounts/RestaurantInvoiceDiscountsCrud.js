...
export function createRestaurantInvoiceDiscount(restaurantInvoiceDiscounts) {
  return axios.post(
    `${RESTAURANTINVOICEDISCOUNTS_URL}/post`,
...
export function getRestaurantInvoiceDiscountById(restaurantInvoiceDiscountsId) {
  return axios.get(
    `${RESTAURANTINVOICEDISCOUNTS_URL}/get/${restaurantInvoiceDiscountsId}`
  );
}
...
export function updateRestaurantInvoiceDiscount(
  id,
  restaurantInvoiceDiscounts
) {
  return axios.put(
    `${RESTAURANTINVOICEDISCOUNTS_URL}/put/${id}`,
    restaurantInvoiceDiscounts
  );
}
// UPDATE Status
export function updateStatusForRestaurantInvoiceDiscounts(ids, status) {
  return axios.post(
    `${RESTAURANTINVOICEDISCOUNTS_URL}/updateStatusForRestaurantInvoiceDiscounts`,
    {
      ids,
      status,
    }
...
export function deleteRestaurantInvoiceDiscount(restaurantInvoiceDiscountsId) {
  return axios.delete(
    `${RESTAURANTINVOICEDISCOUNTS_URL}/delete/${restaurantInvoiceDiscountsId}`
  );
}
// DELETE RestaurantInvoiceDiscounts by ids
export function deleteRestaurantInvoiceDiscounts(ids) {
  return axios.post(
    `${RESTAURANTINVOICEDISCOUNTS_URL}/deleteRestaurantInvoiceDiscounts`,
    ids
  );
}

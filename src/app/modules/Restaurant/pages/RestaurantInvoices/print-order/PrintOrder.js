...
export const PrintReserve = React.forwardRef(({ data }, ref) => {
  ...
  useEffect(() => {
    if(!!data){
      ...
      dataSorted.RestaurantInvoiceDtl = _.orderBy(data.RestaurantInvoiceDtl, ["RestaurantMenuItem.PlaceOfPreparation.Title", "RestaurantMenuItem.RestaurantMenuGroup.Title", "RestaurantMenuItem.NameFa"], ["asc", "asc", "asc"])
  ...
  return (
    <>
      <div ref={ref}>
            ...
            <table className="table" style={{ width: "100%" }}>
              <tbody>
                <tr>
                  <td className="head">
                    <b>شماره فاکتور:</b>{" "}
                    {!!dataPrint == true ? dataPrint.InvoiceNumber + (!!dataPrint.InvoiceSeri && dataPrint.InvoiceSeri > 1  ? "-" + dataPrint.InvoiceSeri: "") : ""}
                  </td>
                  <td className="head">
                    <b>میز:</b>{" "}
                  ...
                  <td colSpan="3" className="bg-black">
                    ...
                    >
                      ...
                      <tbody style={{ backgroundColor: "white" }}>
                        {!!dataPrint == true ? (
                          dataPrint.RestaurantInvoiceDtl.filter(x=>x.SavedRestaurantInvoiceId == x.RestaurantInvoiceId).map((model) => (
        ...
        {!!dataPrint && dataPrint.RestaurantInvoiceDtl.filter(
          (x) => 
            x.SavedRestaurantInvoiceId == x.RestaurantInvoiceId && 
            x.RestaurantMenuItem.PlaceOfPreparationId == 1).length > 0 && (          
          <div
            className="bill rtl"
            style={{
              direction: "rtl",
        ...
        {!!dataPrint && dataPrint.RestaurantInvoiceDtl.filter(
          (x) => 
            x.SavedRestaurantInvoiceId == x.RestaurantInvoiceId && 
            x.RestaurantMenuItem.PlaceOfPreparationId == 2).length > 0 && (
          <div
            className="bill rtl"
            style={{
              direction: "rtl",

...
export const ActionsColumnFormatter = (
  ...
  <>
    <OverlayTrigger
      overlay={
        <Tooltip id="restaurantMenuItemPrices-edit-tooltip">
          {t("Common.Edit")}
        </Tooltip>
      }
    >
      <a
        ...
        onClick={() =>
          openEditRestaurantMenuItemPricePage(row.RestaurantMenuItemPriceId)
        }
      >
    ...
    <OverlayTrigger
      overlay={
        <Tooltip id="restaurantMenuItemPrices-delete-tooltip">
          {t("Common.Delete")}
        </Tooltip>
      }
    >

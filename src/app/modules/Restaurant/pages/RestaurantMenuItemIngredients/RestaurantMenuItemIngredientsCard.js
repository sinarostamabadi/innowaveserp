...
} from "./RestaurantMenuItemIngredientsUIContext";
...
export function RestaurantMenuItemIngredientsCard() {
  ...
  const restaurantMenuItemIngredientsUIProps = useMemo(() => {
    return {
      ...
      newRestaurantMenuItemIngredientButtonClick:
        restaurantMenuItemIngredientsUIContext.newRestaurantMenuItemIngredientButtonClick,
      openDeleteRestaurantMenuItemIngredientsDialog:
        restaurantMenuItemIngredientsUIContext.openDeleteRestaurantMenuItemIngredientsDialog,
      ...
      openUpdateRestaurantMenuItemIngredientsStatusDialog:
        restaurantMenuItemIngredientsUIContext.openUpdateRestaurantMenuItemIngredientsStatusDialog,
      openFetchRestaurantMenuItemIngredientsDialog:
        restaurantMenuItemIngredientsUIContext.openFetchRestaurantMenuItemIngredientsDialog,
    };
  ...
  return (
    <Card>
      <CardHeader
        title={
          t("Common.List") + " " + t("RestaurantMenuItemIngredient.Entity")
        }
      >
        <CardHeaderToolbar>
          <button
            ...
            onClick={
              restaurantMenuItemIngredientsUIProps.newRestaurantMenuItemIngredientButtonClick
            }
          >

...
} from "./RestaurantInvoiceDiscountsUIContext";
...
export function RestaurantInvoiceDiscountsCard() {
  ...
  const restaurantInvoiceDiscountsUIProps = useMemo(() => {
    return {
      ...
      newRestaurantInvoiceDiscountButtonClick:
        restaurantInvoiceDiscountsUIContext.newRestaurantInvoiceDiscountButtonClick,
      openDeleteRestaurantInvoiceDiscountsDialog:
        restaurantInvoiceDiscountsUIContext.openDeleteRestaurantInvoiceDiscountsDialog,
      ...
      openUpdateRestaurantInvoiceDiscountsStatusDialog:
        restaurantInvoiceDiscountsUIContext.openUpdateRestaurantInvoiceDiscountsStatusDialog,
      openFetchRestaurantInvoiceDiscountsDialog:
        restaurantInvoiceDiscountsUIContext.openFetchRestaurantInvoiceDiscountsDialog,
    };
  ...
  return (
    <Card>
      <CardHeader
        title={t("Common.List") + " " + t("RestaurantInvoiceDiscount.Entity")}
      >
        <CardHeaderToolbar>
          <button
            type="button"
            ...
            onClick={
              restaurantInvoiceDiscountsUIProps.newRestaurantInvoiceDiscountButtonClick
            }
          >

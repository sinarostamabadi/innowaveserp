...
import { usePoolReservePricesUIContext, PoolReservePricesUIConsumer } from "./PoolReservePricesUIContext";
...
export function PoolReservePricesCard() {
  ...
  const poolReservePricesUIProps = useMemo(() => {
    return {
      ...
      newPoolReservePriceButtonClick: poolReservePricesUIContext.newPoolReservePriceButtonClick,
      openDeletePoolReservePricesDialog: poolReservePricesUIContext.openDeletePoolReservePricesDialog,
      openEditPoolReservePricePage: poolReservePricesUIContext.openEditPoolReservePricePage,
      openUpdatePoolReservePricesStatusDialog: poolReservePricesUIContext.openUpdatePoolReservePricesStatusDialog,
      openFetchPoolReservePricesDialog: poolReservePricesUIContext.openFetchPoolReservePricesDialog,
    };

...
import { usePoolTimePriceingUIContext, PoolTimePriceingUIConsumer } from "./PoolTimePriceingUIContext";
...
export function PoolTimePriceingCard() {
  ...
  const poolTimePriceingUIProps = useMemo(() => {
    return {
      ...
      newPoolTimePriceingButtonClick: poolTimePriceingUIContext.newPoolTimePriceingButtonClick,
      ...
      openUpdatePoolTimePriceingStatusDialog: poolTimePriceingUIContext.openUpdatePoolTimePriceingStatusDialog,
      openFetchPoolTimePriceingDialog: poolTimePriceingUIContext.openFetchPoolTimePriceingDialog,
    };

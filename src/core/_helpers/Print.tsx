    ...
    public handlePrint = () => {
        ...
        printWindow.onload = () => {
            ...
            if (domDoc) {
                ...
                link.href = "/css/fontiran.css";      /**** your CSS file ****/ 
                link.rel = "stylesheet"; 
                link.type = "text/css"; 
                domDoc.head.appendChild(link);
        
                let link2 = document.createElement("link");
                link2.href = "/css/print.css";      /**** your CSS file ****/ 
                link2.rel = "stylesheet"; 
                link2.type = "text/css"; 
                domDoc.head.appendChild(link2);
